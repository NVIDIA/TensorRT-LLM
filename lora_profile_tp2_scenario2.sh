...
echo "=== LoRA TRT gptManagerBenchmark TP=2 Scenario 2 Profiling ==="
echo "=============================================================="
echo "Scenario 2: Engine WITH LoRA, Requests WITHOUT LoRA"
echo ""
...
# ============================================================================
# TP=2 Scenario 2: Engine WITH LoRA, Requests WITHOUT LoRA
# ============================================================================
...
echo "Running nsys profiling for Scenario 2 TP=${TP}..."
mkdir -p ${EG_DIR}/profiles/scenario2-lora-engine-no-lora-requests-tp-${TP}
...
nsys profile \
    ...
    --output=${EG_DIR}/profiles/scenario2-lora-engine-no-lora-requests-tp-${TP}/gpt_manager_scenario2_tp2 \
...
echo "Scenario 2 profiling completed for TP=${TP}"
echo "Profile saved to: ${EG_DIR}/profiles/scenario2-lora-engine-no-lora-requests-tp-${TP}/gpt_manager_scenario2_tp2.nsys-rep"
echo ""
echo "To view the profile, run:"
echo "nsys-ui ${EG_DIR}/profiles/scenario2-lora-engine-no-lora-requests-tp-${TP}/gpt_manager_scenario2_tp2.nsys-rep"
