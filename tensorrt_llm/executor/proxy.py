...
from .utils import (ExecutorResponse, IntraProcessQueue,
...
class ExecutorBindingsProxy(GenerationExecutor):
    ...
    def dispatch_result_task(self) -> bool:
        ...
        def process_res(res):
            ...
            if (isinstance(res, tllm.Response) and res.result.is_final) or \
                    (isinstance(res, ExecutorResponse) and res.is_final):
