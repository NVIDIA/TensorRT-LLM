...
from .utils import ErrorResponse, is_control_only_llm_response, is_llm_response
    ...
    def handle_responses(self, responses: list[GenerationResult]) -> bool:
        ...
        def process_res(res: list):
            for r in res:
                ...
                if (
                    is_llm_response(r) and not is_control_only_llm_response(r) and r.result.is_final
