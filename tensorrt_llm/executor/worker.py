...
class GenerationExecutorWorker(GenerationExecutor):
    ...
    def _enqueue_request(self, request: GenerationRequest) -> int:
        ...
        if request.disaggregated_params is not None:
            assert self.engine.kv_cache_transceiver is not None, "kv_cache_transceiver is disabled, please set 'cache_transceiver_config:\n backend: ` in config file for disaggregated serving"
