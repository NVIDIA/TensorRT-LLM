...
if __name__ == "__main__":
    ...
    if sm_version != "120":
        print("SVDQuant is only supported on SM 120, skipping test")
        exit(0)
    ...
    bf16_weights = load_file(
        "./bf16_checkpoint/transformer/diffusion_pytorch_model-00001-of-00003.safetensors"
    )
