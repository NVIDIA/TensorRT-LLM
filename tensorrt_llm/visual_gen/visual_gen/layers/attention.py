...
from visual_gen.layers.utils import (
    cp_wrapper,
...
class ditAttnProcessor:
        ...
        if attn_type == "auto":
            ...
            if AttentionOpManager.num_timesteps_high_precision != 0.0:
                ...
                if (
                    ...
                    < num_inference_steps * AttentionOpManager.num_timesteps_high_precision
                ):
            ...
            if AttentionOpManager.num_layers_high_precision != 0.0:
                ...
                if (
                    current_dit_block_id
                    < num_dit_layers * AttentionOpManager.num_layers_high_precision
                ):
                    attn_type = AttentionOpManager.high_precision_attn_type
                    logger.debug(
    ...
    def visual_gen_attn(
        ...
        if (
            AttentionOpManager.attn_type == "auto"
            and auto_tuner is not None
            and auto_tuner.mode == "tuning"
        ):
            layer_name = self.name
