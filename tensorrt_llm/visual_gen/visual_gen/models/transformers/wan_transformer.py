...
class ditWanTransformer3DModel(WanTransformer3DModel, ditBaseTransformer):
    ...
    def run_transformer_blocks(self, hidden_states, encoder_hidden_states, timestep_proj, rotary_emb):
    ...
    def forward(
        ...
        if TeaCacheConfig.enable_teacache():
            ...
            hidden_states = self.run_transformer_blocks(hidden_states, encoder_hidden_states, timestep_proj, rotary_emb)
