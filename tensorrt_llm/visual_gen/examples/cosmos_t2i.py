...
from visual_gen.pipelines.cosmos_pipeline import ditCosmos2TextToImagePipeline
...
def main():
    ...
    parser.set_defaults(
        model_path="nvidia/Cosmos-Predict2-2B-Text2Image",
    ...
    if not args.disable_parallel_vae:
        logger.warning("Parallel VAE is not supported for Cosmos T2I, disable parallel VAE")
    ...
    if args.enable_teacache:
        logger.warning("TeaCache is not supported for Cosmos T2I, disable TeaCache")
    ...
    save_output(frames, output_path, output_type="image")
