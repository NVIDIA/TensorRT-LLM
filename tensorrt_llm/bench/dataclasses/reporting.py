...
class ReportUtility:
    ...
    def get_statistics_dict(self) -> Dict[str, Any]:
        ...
        stats_dict["world_info"] = {
            "tp_size": self.rt_cfg.engine_world_map["tp_size"],
            "pp_size": self.rt_cfg.engine_world_map["pp_size"],
            "ep_size": self.rt_cfg.engine_world_map["moe_ep_size"],
            "world_size": self.rt_cfg.engine_world_map["world_size"],
        ...
        stats_dict["performance"] = {
            ...
            self.output_throughput_tok_s /
            self.rt_cfg.engine_world_map["world_size"],
