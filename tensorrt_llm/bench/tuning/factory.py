...
class HeuristicFactory:
    ...
    @classmethod
    def get_heuristic(cls, backend: str, heuristic_name: str) -> Type[HueristicProtocol]:
        """
    ...
    @classmethod
    def list_available_heuristics(cls, backend: Optional[str] = None) -> list[str]:
        """
    ...
    @classmethod
    def register_heuristic(cls, backend: str, name: str, heuristic_class: Type[HueristicProtocol]) -> None:
        """
