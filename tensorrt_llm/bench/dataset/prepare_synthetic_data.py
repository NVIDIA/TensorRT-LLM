...
from tensorrt_llm.bench.dataset.utils import (gen_random_tokens,
...
def token_norm_dist(root_args, **kwargs):
    ...
    input_ids = gen_random_tokens(input_lens, root_args.tokenizer,
                                  root_args.random_seed)
    _, print_task_ids, lora_config = _generate_task_ids_and_lora_config(
        root_args, num_reqs)
    dataset_generator = generate_text_dataset(input_ids,
                                              output_lens,
