    ...
    def open_mnnvl_memory(cls, mapping: Mapping, size: int):
        ...
        try:
            if (
                ...
                # The helper is atomic: on failure it cleans up any partial
                # remote fds itself before re-raising, so no fd cleanup is
                # needed here.
                all_handles_data = MnnvlMemory._exchange_fds_via_unix_socket(
