...
from .openai_protocol import ChatCompletionToolsParam, FunctionCall, ToolCall
...
def detect_and_parse_function_calls(
        text: str,
        available_tools: List[ChatCompletionToolsParam]) -> List[ToolCall]:
...
def validate_function_arguments(
        ...
        available_tools: List[ChatCompletionToolsParam]) -> bool:
