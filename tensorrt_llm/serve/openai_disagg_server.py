...
from tensorrt_llm.llmapi.disagg_utils import (ConditionalDisaggConfig,
                                              ...
                                              ObservabilityConfig, RouterConfig)
...
class OpenAIDisaggServer:
    ...
    def __init__(self,
                 ...
                 observability_cfg: Optional[ObservabilityConfig] = None):
        ...
        self.observability_cfg = observability_cfg
        ...
        try:
            ...
            if not req.stream:
                ...
                return StreamingResponse(
                    self.merge_streaming_responses(ctx_response, gen_server, req, trace_headers),
