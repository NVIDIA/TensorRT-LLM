...
MM_PARSER_MAP: dict[str, Callable[[ChatCompletionContentPartParam], Union[
    str, dict[str, str]]]] = {
        ...
        "input_audio":
        lambda part: _AudioParser(part).get("input_audio", {}).get("url", None),
    }
...
def parse_chat_message_content_part(
    ...
    # if part_type is text/image_url/video_url/input_audio but content is None, log a warning and skip
