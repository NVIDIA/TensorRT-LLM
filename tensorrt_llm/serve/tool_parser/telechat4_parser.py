...
class TeleChat4ToolParser(BaseToolParser):
    """Tool parser for the TeleChat4 tool-call format.
    ...
    def detect_and_parse(self, text: str, tools: List[Tool]) -> StreamingParseResult:
        ...
        try:
            ...
            logger.exception("Failed to extract TeleChat4 tool call spec")
            return StreamingParseResult(normal_text=text, calls=[])
    ...
    def parse_streaming_increment(self, new_text: str, tools: List[Tool]) -> StreamingParseResult:
        ...
        while True:
            ...
            if inner_match is None:
                logger.warning(
                    "TeleChat4 tool block did not match expected shape: %r",
                    block,
                )
            ...
            try:
                ...
                logger.exception(
                    "Failed to parse TeleChat4 tool call payload: %r",
                    inner_match.group(1),
                )
                tool_name, arguments = "", {}
