...
class Xing4_0ToolParser(BaseToolParser):
    """Tool parser for the Xing4.0 tool-call format.
    ...
    def parse_streaming_increment(self, new_text: str, tools: List[Tool]) -> StreamingParseResult:
        ...
        while True:
            ...
            if inner_match is None:
                logger.warning(
                    "Xing4.0 tool block did not match expected shape: %r",
                    block,
                )
            ...
            try:
                ...
                logger.exception(
                    "Failed to parse Xing4.0 tool call payload: %r",
                    inner_match.group(1),
                )
                tool_name, arguments = "", {}
