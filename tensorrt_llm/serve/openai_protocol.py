...
class VideoGenerationRequest(OpenAIBaseModel):
    ...
    input_reference: Optional[Union[str, UploadFile]] = Field(
        ...
        description=(
            ...
            "HEIF/AVIF still images share the ISO-BMFF signature with "
            "MP4 and are rejected with a 400 asking for PNG/JPEG rather "
            "than routed to the video decoder. Undecodable or "
