...
class BaseLlmArgs(StrictBaseModel):
    ...
    @staticmethod
    def _check_executor_config_consistency():
...
BaseLlmArgs._check_executor_config_consistency()
...
class TorchLlmArgs(BaseLlmArgs):
    ...
    # PrivateVars
    _quant_config: Optional[QuantConfig] = PrivateAttr(
