...
# ---------------------------------------------------------------------------
# K3 MLA attention: specialization of the shared PyTorch-backend ``MLA``.
#
# The base ``MLA`` class owns context attention, cached/chunked prefill,
# absorbed generation, and paged-cache handling. This section only supplies
# the K3 projection topology, NoPE identity table, KV-B checkpoint layout,
