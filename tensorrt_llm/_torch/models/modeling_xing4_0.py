...
"""Xing4.0 TRT-LLM PyTorch model with mHC residual mixing."""
...
def _patch_rope_scaling(config: PretrainedConfig) -> None:
    """Normalize Xing4.0 rope scaling for TRT-LLM."""
...
class Xing4_0DecoderLayer(DecoderLayer):
...
class Xing4_0Model(DecoderModel):
    def __init__(self, model_config: ModelConfig[PretrainedConfig]):
        ...
        self.layers = nn.ModuleList(
            [
                Xing4_0DecoderLayer(model_config, layer_idx, self.aux_stream_dict)
...
class Xing4_0WeightLoader(DeepseekV3WeightLoader):
    """Load Xing4.0 weights and reuse the DeepSeekV3 loader."""
...
@register_auto_model("Xing4_0ForCausalLM")
class Xing4_0ForCausalLM(SpecDecOneEngineForCausalLM[Xing4_0Model, PretrainedConfig]):
    def __init__(self, model_config: ModelConfig[PretrainedConfig]):
    ...
    def load_weights(self, weights):
        loader = Xing4_0WeightLoader(self)
