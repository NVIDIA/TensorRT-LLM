    ...
    def get_num_tokens_per_video(
        ...
        **kwargs,
        ...
        if video_pruning_rate > 0:
            ...
            num_total_tokens += num_tubelets * len(self.get_mm_special_token_ids())
        else:
            # No pruning: tokens_per_unit * num_tubelets + special tokens.
            num_special = len(self.get_mm_special_token_ids())
            num_total_tokens = num_tubelets * (tokens_per_unit + num_special)
