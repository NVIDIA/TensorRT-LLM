...
class BaseWeightMapper(ABC):
    ...
    def build_weight_load_plan(self,
        ...
        if os.environ.get("TRT_LLM_DISABLE_LOAD_WEIGHTS_IN_PARALLEL",
            ...
            # The serial override bypasses preload grouping in the native
            # materializer; do not apply the concurrent-path ordering hints.
        ...
        # Equal priorities let read-ahead preserve physical locality without
        # inventing dependencies between these consumers.
