...
from tensorrt_llm._torch.models.modeling_utils import (DecoderModelForCausalLM,
                                                       register_auto_mapper)

from ..weight_mapper_interface import WeightMapperInterface, guard_all_methods


@register_auto_mapper("HF")
@guard_all_methods
class HfWeightMapper(WeightMapperInterface):
