# Copy from https://huggingface.co/microsoft/Phi-4-multimodal-instruct/blob/main/configuration_phi4mm.py
# since Phi4MMConfig in transformers library is not compatible with HF codes.
