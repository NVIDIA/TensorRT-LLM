...
class LlamaDecoderLayer(DecoderLayer):
    ...
    def __init__(
        ...
        self.disable_nvfp4_layernorm_fusion = os.environ.get(
            "TRTLLM_DISABLE_NVFP4_LAYERNORM_FUSION", "0") == "1"
        ...
        # logger.info(f"self.enable_fusion: {self.enable_fusion}, self.disable_nvfp4_layernorm_fusion: {self.disable_nvfp4_layernorm_fusion}, self.is_nvfp4: {self.is_nvfp4}, differ_pp_stage_with_previous_layer: {differ_pp_stage_with_previous_layer}, RMSNorm")
