...
from .modeling_speculative import (Eagle3DraftModel, Eagle3ForCausalLM,
                                   Eagle3OneEnginelForCausalLM)
...
class Eagle3LlamaForCausalLM(Eagle3ForCausalLM[Eagle3LlamaDraftModel,
                                               LlamaConfig]):

    def __init__(self,
                 model_config: ModelConfig[LlamaConfig],
                 start_layer_idx: int = 0):
        super().__init__(Eagle3LlamaDraftModel(model_config, start_layer_idx),
                         model_config)
...
class LlamaForCausalLM(Eagle3OneEnginelForCausalLM[LlamaModel,
    ...
    def __init__(
        ...
        super().__init__(LlamaModel(model_config), Eagle3LlamaForCausalLM,
                         model_config)
...
class Llama4ForConditionalGeneration(
        Eagle3OneEnginelForCausalLM[Llama4Model, Eagle3LlamaForCausalLM,
                                    Llama4Config]):
    ...
    def __init__(
        ...
        super().__init__(Llama4Model(model_config), Eagle3LlamaForCausalLM,
                         model_config)
