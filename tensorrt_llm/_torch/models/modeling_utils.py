...
class DecoderModelForCausalLM(nn.Module,
    ...
    def load_weights(self,
        ...
        if weight_mapper is None:
            ...
            _load_weights_impl_experimental(self, weights, weight_mapper,
                                            skip_modules)
...
def get_checkpoint_weight_loader(name: str) -> "WeightLoaderInterface":
...
def _load_weights_impl_experimental(model: Union[nn.Module,
                                                 DecoderModelForCausalLM],
                                    weights: Dict,
                                    weight_mapper: "WeightMapperInterface",
                                    skip_modules: List[str] = [],
                                    params_map: Optional[Dict[str,
                                                              str]] = None):
    weight_mapper.skip_modules = skip_modules
    if params_map is not None:
