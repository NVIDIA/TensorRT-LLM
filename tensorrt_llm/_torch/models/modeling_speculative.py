...
class Eagle3DraftModel(DecoderModel, Generic[TAttention, TConfig]):
    ...
    def __init__(
        ...
        self.midlayer = Eagle3DecoderLayer[TAttention, TConfig](attention_class,
                                                                model_config,
                                                                start_layer_idx)
...
class Eagle3ForCausalLM(DecoderModelForCausalLM[TModel, TConfig],
...
class Eagle3OneEnginelForCausalLM(DecoderModelForCausalLM[TModel, TConfig],
                                  Generic[TModel, TEagle3DraftCausalLM,
                                          TConfig]):

    def __init__(self, model: TModel,
                 eagle3_draft_causal_lm: Type[TEagle3DraftCausalLM],
