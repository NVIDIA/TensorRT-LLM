    ...
    def __init__(self, model: TModel, model_config: ModelConfig[TConfig]):
        ...
        if spec_config and spec_config.spec_dec_mode.use_one_engine():
            if spec_config.spec_dec_mode.is_eagle3_one_model(
                ...
                if self.draft_config.quant_config.quant_algo == QuantAlgo.FP8_BLOCK_SCALES and self.draft_config.moe_backend == "CUTLASS":
                    logger.warning(
                ...
                if self.draft_config.quant_config.quant_algo == QuantAlgo.FP8_BLOCK_SCALES and self.draft_config.moe_backend == "TRTLLM":
                    ...
                    if get_sm_version() == 100:
                        ...
                        self.draft_config._frozen = False
                        self.draft_config.moe_backend = "CUTLASS"
                        self.draft_config._frozen = True
            ...
            if self.draft_config is not None and not model_config.spec_config.eagle3_mistral_large_3:
