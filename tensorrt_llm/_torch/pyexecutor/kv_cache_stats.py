...
def serialize_kv_cache_iteration_stats(stats, keys: tuple[str, ...] | None = None) -> dict:
    fields = {
        ...
        "primaryEvictableNumBlocks": getattr(stats, "primary_evictable_num_blocks", 0),
        "primaryPeakUsedNumBlocks": getattr(
            stats,
            "primary_peak_used_num_blocks",
            stats.primary_used_num_blocks,
        ),
        ...
        "secondaryEvictableNumBlocks": getattr(stats, "secondary_evictable_num_blocks", 0),
        "secondaryPeakUsedNumBlocks": getattr(
            stats,
