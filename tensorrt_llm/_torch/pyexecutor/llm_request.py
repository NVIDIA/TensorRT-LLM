...
class LogitsStorage:
    ...
    def __init__(self, seq_length: int, device_memory=True):
...
class PyResult:
    ...
    def __init__(self,
        ...
        self._context_logits = LogitsStorage(
            prompt_len, device_memory) if return_context_logits else None
        self._generation_logits = LogitsStorage(
            max_new_tokens, device_memory) if return_generation_logits else None
