...
class KVCacheManagerV2(BaseResourceManager):
    ...
    def copy_batch_block_offsets(
        ...
        if self.enable_swa_scratch_reuse:
            # NOTE: this per-layer path has its own analogue of the nvbug
            # 6293536 race below (async copies of the persistent
            # host_kv_cache_block_offsets buffer and the copyIndex_ slice read
            # host memory at execution time); it needs a separate fix.
