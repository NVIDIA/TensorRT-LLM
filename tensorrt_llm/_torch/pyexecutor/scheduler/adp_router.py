...
from .rank_state import RankIterStatsPayload, RankState
...
class ADPRouter(ABC):
    ...
    def gather_all_rank_states(
        ...
        include_kv_cache_load: bool = False,
    ) -> list[RankState]:
        ...
        responses = self.dist.tp_allgather(local_state.serialize(include_kv_cache_load))
