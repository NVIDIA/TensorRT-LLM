...
class DisaggTransferAdmissionController:
    ...
    def _observe_diagnostic_budget_multiplier(
        ...
        observation_threshold_blocks = (self.base_max_transfer_blocks *
                                        (self.admission_budget_multiplier - 1))
        ...
        if (result.admitted_transfer_blocks == 0
                or used_blocks <= observation_threshold_blocks
        ...
        logger.info(
            ...
            f"{used_blocks} transfer blocks, exceeding the "
            f"{self.admission_budget_multiplier - 1}x comparison window of "
            f"{observation_threshold_blocks} blocks (base window="
            f"{self.base_max_transfer_blocks} blocks, admission budget "
            f"multiplier={self.admission_budget_multiplier})")
