...
class PyExecutor:
    ...
    def __init__(self,
        ...
        self.stream_interval = model_engine.llm_args.stream_interval
        self.attention_dp_enable_balance = model_engine.llm_args.attention_dp_enable_balance
        self.attention_dp_time_out_iters = model_engine.llm_args.attention_dp_time_out_iters
        self.attention_dp_batching_wait_iters = model_engine.llm_args.attention_dp_batching_wait_iters
        self.batch_wait_timeout_ms = model_engine.llm_args.batch_wait_timeout_ms
        self.batch_wait_timeout_iters = model_engine.llm_args.batch_wait_timeout_iters
        self.batch_wait_max_tokens_ratio = model_engine.llm_args.batch_wait_max_tokens_ratio
