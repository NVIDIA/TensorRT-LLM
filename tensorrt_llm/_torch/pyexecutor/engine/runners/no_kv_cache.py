...
class NoKVCacheRunner(ABC):
    ...
    def prepare_inputs(
        ...
        *,
            ...
            if request.py_multimodal_data is not None:
                multimodal_params = MultimodalParams(
                    multimodal_input=_build_request_multimodal_input(
                        request,
                        runner_config.mm_encoder_cache_enabled,
                    ),
        ...
        assert num_tokens <= runner_config.max_num_tokens, (
        ...
        attn_metadata.padded_num_tokens = (
            padded_num_tokens if padded_num_tokens != num_tokens else None
        )
