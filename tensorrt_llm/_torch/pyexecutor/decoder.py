...
class TRTLLMDecoder(Decoder):
    ...
    def setup_decoder(self, scheduled_requests: ScheduledRequests,
        ...
        for req in itertools.chain(scheduled_requests.context_requests,
            ...
            assert not req.py_return_context_logits, "return_context_logits not implemented for TRTLLMDecoder"
            assert not req.py_return_generation_logits, "return_generation_logits not implemented for TRTLLMDecoder"
            assert not req.py_return_log_probs, "return_log_probs not implemented for TRTLLMDecoder"
