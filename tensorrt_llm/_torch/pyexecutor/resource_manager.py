...
class MambaCacheManager(BaseResourceManager):
    ...
    def prepare_mamba_cache_blocks(self, request_ids: List[int]):
        ...
        state_indices = torch.tensor(state_indices, dtype=torch.int32, pin_memory=True)
        self.state_indices[:state_indices.shape[0]].copy_(state_indices, non_blocking=True)
