...
class KVCacheManager(BaseResourceManager):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        # FIXME: flashinfer.py accesses
        # max_num_pages = self.kv_cache_manager.blocks_in_primary_pool
        # This dependency should be adjusted as it does not cover VSWA scheme
        if is_estimating_kv_cache:
            ...
            self.blocks_in_primary_pool = math.ceil(kv_cache_config.max_tokens /
                                                    tokens_per_block)
