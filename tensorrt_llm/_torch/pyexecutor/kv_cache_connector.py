...
class KvCacheConnectorScheduler(ABC):
    ...
    def wait_for_ready(self):
        """
        Some connectors need to wait for some resources to be ready.
        For example, FlexKV needs to wait for the FlexKV manager to be ready.
        """
        return
