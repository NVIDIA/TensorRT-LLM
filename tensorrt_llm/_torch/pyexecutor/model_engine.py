...
class PyTorchModelEngine(ModelEngine):
    ...
    def _prepare_tp_inputs(
        ...
        for request in scheduled_requests.context_requests:
            ...
            if self.is_draft_model and num_accepted_tokens_device is not None:
                ...
                slot_idx = previous_request_slots[request.py_request_id]
                    ...
                    if not request.is_cuda_graph_dummy:
                        for beam in range(beam_width):
                            ...
                            if self.is_draft_model and num_accepted_tokens_device is not None:
                                ...
                                end_idx = len(input_ids)
                                slot_idx = previous_request_slots[
    ...
    def _forward_decoder(
        ...
        previous_request_slots = forward_inputs.previous_request_slots
