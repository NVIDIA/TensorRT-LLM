...
from .config_utils import is_mla, is_nemotron_hybrid, is_qwen3_next, is_qwen3_5
...
def get_kv_cache_manager_cls(model_config: ModelConfig,
    ...
    elif is_nemotron_hybrid(config) or is_qwen3_next(config) or is_qwen3_5(config):
