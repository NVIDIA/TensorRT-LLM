...
class KvCacheCreator:
    ...
    def _create_dummy_context_requests(self, py_executor: PyExecutor,
                                       origin_seq_len: int):
        ...
        max_seq_len = origin_seq_len - 1 if type(
    ...
    def _get_token_num_for_estimation(self) -> int:
        ...
        assert executor_config.max_batch_size <= executor_config.max_num_tokens
    ...
    def maybe_prepare_estimation(self):
    ...
    def estimate_max_tokens(self, py_executor: PyExecutor,
                            origin_seq_len: int) -> None:
        ...
        if py_executor.dist.mapping.rank == 0:
            req = self._create_dummy_context_requests(
                py_executor, origin_seq_len=origin_seq_len)
