...
#
# NOTE: This is a local copy of tensorrt_llm/quantization/utils/fp8_matrix_weight_dequant.py
# to avoid a dependency on the tensorrt_llm.quantization package in standalone mode.
