...
class KVPagedResourceHandler(ResourceHandler):
    ...
    This handler enables the standard KVCacheManager layout with kv_factor=2 (combined K/V).
    Uses explicit num_kv_heads and head_dim attributes for compatibility checking with KVCacheManager.
    ...
    def __init__(
        ...
        self.size_per_token = num_kv_heads * kv_factor * head_dim

    def __eq__(self, other: Optional["KVPagedResourceHandler"]) -> bool:
...
class StateResourceHandler(ResourceHandler):
    ...
    def __eq__(self, other: Optional["StateResourceHandler"]) -> bool:
