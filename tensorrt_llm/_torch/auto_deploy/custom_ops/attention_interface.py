...
class SequenceInfo:
    ...
    def estimate_cache_loc_capacity(self, num_blocks: int) -> None:
        ...
        This is a backward-compatible wrapper for call sites that predate
        :meth:`update_cache_information`.
        """
        self.update_cache_information(num_blocks=num_blocks, block_offset_multiplier=0)
