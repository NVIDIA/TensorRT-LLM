...
| `torch.ops.auto_deploy.torch_moe_router` | MoE routing: fused softmax + top-k + optional normalization |
...
| `torch.ops.auto_deploy.triton_moe_router` | Triton fused MoE routing: softmax + top-k + optional normalization |
