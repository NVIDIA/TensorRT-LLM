...
class TorchMLABackend(AttentionDescriptor):
    ...
    def get_num_qkv_args(cls) -> int:
        ...
        # (q_normed_dn, compressed_kv, k_pe), (sin_cache, cos_cache),
        # (wkv_b, wq_b, w_uq_ukv, wo_proj, w_uv_o)
        return 10
    ...
    def get_cache_initializers(
        ...
        def _create_ckv_cache(si: SequenceInfo):
            ...
            #     si.num_pages, si.page_size, head_dim_ckv, si.device,
            #     dtype=cache_config.dtype or kv_fake.dtype, init_randn=False
            # )
        ...
        def _create_kpe_cache(si: SequenceInfo):
            head_dim_kpe = 64
            # return _create_paged_cache(
            #     si.num_pages, si.page_size, head_dim_kpe, si.device,
            #     dtype=cache_config.dtype or kv_fake.dtype, init_randn=False
            # )
            return _create_linear_caches(
                si.max_batch_size,
