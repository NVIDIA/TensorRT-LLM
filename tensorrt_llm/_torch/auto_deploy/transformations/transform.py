...
class InferenceOptimizer:
    def __init__(self, factory: ModelFactory, ad_config: AutoDeployConfig, local_device: str):
    ...
    def __call__(self, cm: CachedSequenceInterface) -> nn.Module:
        ...
        new_optimizer = ModularInferenceOptimizer(
            self.factory, self.ad_config.transforms, self.local_device
        )
