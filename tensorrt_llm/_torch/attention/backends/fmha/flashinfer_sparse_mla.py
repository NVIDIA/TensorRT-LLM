...
class FlashInferSparseMlaFmha(Fmha):
    ...
    def forward(
        ...
        if algorithm == "deepseek_v4":
            from tensorrt_llm._torch.attention.backends.sparse.deepseek_v4.flashinfer import (
            ...
            return
        if algorithm == "dsa":
            from tensorrt_llm._torch.attention.backends.sparse.dsa_flashinfer import (
                run_flashinfer_sparse_mla,
            )
