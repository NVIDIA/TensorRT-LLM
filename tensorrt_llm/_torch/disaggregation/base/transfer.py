...
from tensorrt_llm._torch.disaggregation.protocol import TransferProtocolIdentity
...
class KVSlice:
    ...
    # The allocator lease, rather than a copied request ID or raw identity,
    # is the authority for this slice's allocation generation.
    allocation_lease: object | None = None
