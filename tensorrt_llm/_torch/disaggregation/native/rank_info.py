...
class RankInfo:
    ...
    def to_bytes(self) -> bytes:
        ...
        # Keep disabled workers wire-compatible with peers that predate this
        # field. An enabled worker advertises the version intentionally so an
        # old peer rejects the message instead of mixing ownership contracts.
