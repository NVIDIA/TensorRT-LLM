...
# GIL per slice per writer): instance_rank, unique_rid, optional request_epoch, slice_id,
# is_last, status, transfer_size. The optional sender endpoint and bounce tail follow.
_KV_RESULT_PREFIX = struct.Struct("<qqq?Bq")
_KV_RESULT_PREFIX_V2 = struct.Struct("<qqqq?Bq")
