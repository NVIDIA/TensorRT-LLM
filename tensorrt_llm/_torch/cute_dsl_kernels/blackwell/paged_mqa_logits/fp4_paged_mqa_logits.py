...
# ============================================================================
# Standalone test driver (no tensorrt_llm dependency).
#
# Usage:
#     python fp4_paged_mqa_logits.py --batch_size 1 4 --next_n 1 2 3 \
#                                    --avg_ctx 4096 --phys_block_kv 128
#
...
import torch  # noqa: E402  (standalone driver block, kept self-contained)
