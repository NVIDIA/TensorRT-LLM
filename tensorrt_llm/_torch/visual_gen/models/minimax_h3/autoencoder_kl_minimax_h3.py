...
class MiniMaxH3VideoTransformerBlock(nn.Module):
    def __init__(
        ...
        self.ff = MiniMaxH3FeedForward(dim, mult=ffn_mult, activation_fn="swiglu", bias=bias)
...
class AutoencoderKLMiniMaxH3(MiniMaxH3ModelMixin):
    r"""
    ...
    def disable_tiling(self) -> None:
        """Disable spatially tiled encoding and decoding."""
        self.use_tiling = False

    def enable_slicing(self) -> None:
        """Decode batch elements one at a time to reduce peak memory."""
        self.use_slicing = True

    def disable_slicing(self) -> None:
        """Decode all batch elements together."""
        self.use_slicing = False
    ...
    ) -> MiniMaxH3AutoencoderKLOutput | tuple[torch.Tensor]:
    ...
    def decode(
        ...
        if not return_dict:
            return (decoded,)
        return MiniMaxH3DecoderOutput(sample=decoded)
