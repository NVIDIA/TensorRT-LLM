...
# over 50 denoising steps. Keep the unfused fallback in eager mode while exposing
# gelu_tanh through __wrapped__ for NVFP4 GEMM+GELU fusion eligibility.
# See: pytorch/pytorch#145213
_gelu_tanh_eager = torch.compiler.disable(gelu_tanh)
...
class FluxSingleTransformerBlock(nn.Module):
    ...
    def configure_fused_mlp_gelu(self) -> bool:
        ...
        self._use_fused_mlp_gelu = bool(
            is_nvfp4_gemm_gelu_fusion_eligible(self.proj_mlp, self.act_mlp)
