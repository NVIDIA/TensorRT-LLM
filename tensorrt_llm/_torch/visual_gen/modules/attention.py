...
class Attention(nn.Module):
    ...
    def __init__(
        ...
        cross_backend_override = config.attention.cross_attention_backend
        if is_cross_attention and cross_backend_override is not None:
            backend_name = cross_backend_override
        # Cross-attention fallback: TRTLLM and CUTEDSL VSA/Sol-Attn are self-attn only.
        elif self.qkv_mode == QKVMode.SEPARATE_QKV and (
