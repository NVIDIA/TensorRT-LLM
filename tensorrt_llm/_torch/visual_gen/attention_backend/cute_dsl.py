...
JIT-compiles BlackwellFusedMultiHeadAttentionForward (cute_dsl_kernels/blackwell/attention/fmha.py)
and caches the compiled artifact per (dtype, mask, head_dim, ...). Expects NHD [B,S,H,D] fp16/bf16.
"""
