...
This package is vendored wholesale from
...
commit history, not an exact recorded pin from the original port -- see PR
discussion for how this was verified). Checked against the current branch
tip ([`83e54df`](https://github.com/NVlabs/Sana/commit/83e54df), 2026-08-20)
on 2026-08-27: the only relevant upstream change since is a merge whose SM89
...
SM90, and SM100 design scaffold derive from the
[FlashAttention project](https://github.com/Dao-AILab/flash-attention). Its
