...
class ModelDrafter(Drafter):
    ...
    def should_forward_draft_model(self,
        ...
        for request in scheduled_batch.context_requests:
            if request.is_first_context_chunk:
                # DFlash / Domino needs the spec worker forward() to run during
                # first-chunk prefill so _store_prefill_context can project and
                # store the captured target hidden states as cross-attention
                # context. Domino inherits this path from DFlashWorker.
