...
class SuffixDrafter(Drafter):
    ...
    def __init__(
        ...
        assert (
            suffix_cache_manager is not None
    ...
    def prepare_draft_tokens(
        ...
        for request in sorted(
            ...
            num_prompt_tokens = request.py_orig_prompt_len
            ...
            draft = self.spec_resource_manager.suffix_cache.speculate(
                ...
                pattern,
                max_spec_tokens=min(
                    self.max_draft_len, max_sequence_length - num_tokens - 1
                ),
    ...
    def update_max_total_draft_tokens(
        self, new_max_total_draft_tokens: int
    ) -> None:
