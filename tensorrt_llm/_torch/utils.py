...
def gelu_tanh(x: torch.Tensor) -> torch.Tensor:
    """Sentinel activation: GELU with tanh approximation.

    Identity-comparable so MLP can detect this activation and enable the
    fused gelu_tanh + NVFP4 quant fast path.
    """
