...
def mla_dsa_attn_inplace(
    ...
    if metadata.num_contexts > 0:
        ...
        if mla_layer.apply_rotary_emb and ctx_position_ids is not None:
            k_pe_ctx = mla_layer.apply_rope(q_ctx, k_pe_ctx, ctx_position_ids)
    ...
    if metadata.num_generations > 0:
        ...
        if mla_layer.apply_rotary_emb and gen_position_ids is not None:
            k_pe_gen = mla_layer.apply_rope(q_gen, k_pe_gen, gen_position_ids)
