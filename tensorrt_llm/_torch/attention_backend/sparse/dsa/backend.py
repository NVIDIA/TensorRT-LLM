...
import tensorrt_llm._torch.attention_backend.sparse.dsa.custom_ops  # noqa: F401  # register custom ops
...
class DSATrtllmAttention(TrtllmAttention):
    ...
    def forward_sparse_context(
        ...
        **kwargs,
        ...
        """Dispatch sparse context attention (SM>=100: absorption, SM<90: FlashMLA).

        Caller (MLA.forward_context) handles short-seq MHA gating.
        Requires q_fp8 in kwargs from pre_attn_process.
        """
