    ...
    def __init__(
        ...
        **kwargs,
        ...
        if sparse_params is None:
            raise ValueError("sparse_params is required for RocketTrtllmAttention")
        super().__init__(
            layer_idx,
            num_heads,
            head_dim,
...
class RocketVanillaAttention(VanillaAttention):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        if sparse_params is None:
            raise ValueError("sparse_params is required for RocketVanillaAttention")
        super().__init__(
            layer_idx,
            num_heads,
            head_dim,
        ...
        self.kernel_size = sparse_params.kernel_size
        self.page_size = sparse_params.page_size
        assert sparse_params.kt_cache_dtype == "bfloat16", (
    ...
    def _get_snapkv_indices(self, q: Tensor, k: Tensor, sample_idx: int) -> Tensor:
        ...
        score = torch.masked_fill(
            score,
            ~attention_mask.view(1, 1, self.window_size, seq_len),
