...
def is_megamoe_cute_dsl_runtime_available() -> Tuple[bool, Optional[str]]:
    ...
    ``dispatch_kernel.py``. ``nvidia-cutlass-dsl[cu13]`` 4.5.0 was the first
    release that shipped all of them (see PR
    https://github.com/NVIDIA/TensorRT-LLM/pull/14354), and older wheels
    return ``(False, reason)``.
