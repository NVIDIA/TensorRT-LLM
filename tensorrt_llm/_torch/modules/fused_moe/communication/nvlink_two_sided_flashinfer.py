...
class NVLinkTwoSidedFlashinfer(Communication):
    ...
    def __init__(
        ...
        assert use_low_precision_combine is False, "flashinfer use_low_precision_combine must be False"
    ...
    def dispatch(
        ...
        **kwargs,
        ...
        hidden_states, hidden_states_sf, token_selected_slots, token_final_scales = mnnvl_moe_alltoallv_packed(
