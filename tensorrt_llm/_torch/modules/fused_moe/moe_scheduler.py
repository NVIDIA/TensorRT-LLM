...
class ExternalCommMoEScheduler(MoEScheduler):
    ...
    def _forward_chunk_impl(
        ...
        if requires_separated_routing:
            ...
            # Backends disagree on routing-scale precision. The cast replaces
            # both a float32 assertion and a bfloat16 conversion; for the
            # backends that used to assert, routing already produces float32,
