...
def resolve_moe_cls(
    ...
    # base weights (MVP). Fail loudly here rather than at runtime if the
    # user-selected backend cannot serve the LoRA request.
    # Use the resolved class name (e.g. fallback to CutlassFusedMoE keeps LoRA
    # supportable even when the user requested TRTLLM/CUTEDSL).
