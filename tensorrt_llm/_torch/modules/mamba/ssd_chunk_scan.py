...
@triton.autotune(
    configs=[
        ...
        # These eliminate register spilling and improve occupancy from 12.5% to 25%
        # =================================================================
        triton.Config(
            {
                "BLOCK_SIZE_M": 64,
...
def _chunk_scan_fwd_kernel(
    ...
    if IS_TRITON_22 or c_idx > -1:
        ...
        if HAS_SEQ_IDX:
            ...
            if not HAS_INITSTATES:
                ...
                #   required.
                scale_m = tl.math.exp2((dA_cs_m - dA_cs_m_boundary) * 1.4426950408889634)
        else:
    ...
    for k in range(0, K_MAX, BLOCK_SIZE_K):
        ...
        # Use exp2 for faster computation: exp(x) = exp2(x * log2(e))
        cb *= tl.math.exp2((dA_cs_m[:, None] - dA_cs_k[None, :]) * 1.4426950408889634)
