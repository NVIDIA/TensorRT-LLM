...
def _register_fake():
    ...
    @torch.library.register_fake("trtllm::mla_rope_context")
    def _(latent_cache,
          q_buf,
          k_buf,
          v_buf,
    ...
    @torch.library.register_fake("trtllm::mla_context_fp8_quantize")
    def _(latent_cache, q_buf, k_buf, v_buf, quant_q_buf, quant_k_buf,
          quant_v_buf, context_buf, q_pe, cos_sin_cache, workspace,
          cache_seq_lens, seq_q_offset, fmha_tile_counter, cu_q_seqlens,
          cu_kv_seqlens, block_ids_per_seq, bmm1_scale, bmm2_scale,
          quant_scale_o, quant_scale_q, quant_scale_kv, dequant_scale_q,
          dequant_scale_kv, quant_scale_qkv, helix_position_offsets,
          helix_is_inactive_rank, batch_size, acc_q_len, head_num,
          max_input_seq_len, q_pe_ld, q_pe_stride, q_lora_rank, kv_lora_rank,
          qk_nope_head_dim, qk_rope_head_dim, v_head_dim,
          predicted_tokens_per_seq, num_layers, host_bmm1_scale,
          absorption_mode, total_kv_len):
        return
