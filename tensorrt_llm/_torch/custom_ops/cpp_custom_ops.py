...
def _register_fake():
    ...
    def _(qkv_input,
          cross_kv_input,
          quantized_qkv_output,
          q_output,
          kv_cache_block_offsets,
          host_kv_cache_pool_pointers,
          host_kv_cache_pool_mapping,
          qkv_bias,
          qkv_scale_quant_orig,
          qkv_scale_orig_quant,
          o_scale_orig_quant,
          fmha_bmm1_scale,
          fmha_bmm2_scale,
          fmha_tile_counter,
          ...
          separate_q_kv_output,
          quantized_fp8_output,
          generation_phase,
          rotary_vision_start,
          rotary_vision_length,
          layer_idx,
          tokens_per_block,
