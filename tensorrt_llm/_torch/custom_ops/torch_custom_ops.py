...
class MoERunner(TunableRunner):
    ...
    def forward(
        ...
        x, expert_weights, fc2_expert_weights, min_latency_mode_tensor = inputs
        min_latency_mode = min_latency_mode_tensor.size(0) == 1
...
def fused_moe(
    ...
    _, gemm_tactic_2 = tuner.choose_one(
        ...
        [moe_runner],
        tuning_config,
        [input, fc2_expert_weights, fc2_expert_weights, min_latency_tensor],
        gemm_idx=2,
    )
