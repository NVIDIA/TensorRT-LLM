...
def attention(
    ...
    torch.ops.trtllm.attention_inplace(
        ...
        host_past_key_value_lengths, total_kv_lens, context_lengths,
        host_context_lengths, host_request_types, kv_cache_block_offsets,
        ...
        attention_chunk_size, softmax_stats_tensor, spec_decoding_bool_params,
