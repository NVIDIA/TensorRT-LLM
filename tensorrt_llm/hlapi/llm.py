...
class LLM:
    ...
    def generate(
        ...
        Args:
            prompts (Union[str, Iterable[str], List[int], Iterable[List[int]]]): The prompt text or token ids.
    ...
    def generate_async(
        ...
        Args:
            prompt (Union[str, List[int]]): The prompt text or token ids; must be single prompt.
