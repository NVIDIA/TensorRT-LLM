...
class SamplingParams:
    ...
    Args:
        ...
        top_k (int, optional): Controls number of logits to sample from. Can assume non-negative values, where 0 means 'all logits'. Defaults to None (not specified).
        ...
        top_p (float, optional): Controls the top-P probability to sample from. Can have values between 0 and 1. Defaults to None (not specified).
            If neither temperature, top_p, nor top_k are specified, sampling is greedy.
        ...
        temperature (float, optional): Controls the modulation of logits when sampling new tokens. It can have values >= 0.f. Defaults to None (not specified).
            If neither temperature, top_p, nor top_k are specified, sampling is greedy.
