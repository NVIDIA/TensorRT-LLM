...
class SamplingParams:
    ...
    Args:
        ...
        beam_search_diversity_rate (float, optional): Encourages beams to diverge from each other by adding diversity_rate * source_beam_index to each candidate's ranking score during beam expansion, boosting candidates that expand from lower-ranked beams. None means using C++ runtime default 0.f (disabled). Defaults to None.
