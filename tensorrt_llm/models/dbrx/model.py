...
class DbrxDecoderLayer(Module):
    def __init__(self, config: PretrainedConfig, layer_idx: int):
        ...
        ClsMLP = GatedMLP if is_gated_activation(config.hidden_act) else MLP
        ...
        self.attention = Attention(
            ...
            bias=config.bias,
            position_embedding_type=PositionEmbeddingType.from_string(str(config.position_embedding_type)),
...
class DbrxForCausalLM(DecoderModelForCausalLM, TopModelMixin):
