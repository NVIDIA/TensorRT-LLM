    ...
    def forward(self,
        ...
        if not default_net(
            ...
            raise AssertionError(
                "You need to enable the LayerNorm plugin for Phi with TensorRT 8.6. Please set plugin_config.layernorm_plugin"
            )
...
class PhiForCausalLM(PhiModel, GenerationMixin):
