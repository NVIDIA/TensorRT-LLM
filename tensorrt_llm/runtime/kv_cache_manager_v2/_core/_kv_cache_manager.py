...
class KVCacheManager:
    ...
    def create_kv_cache(
        ...
        cache_salt_id: optional salt to merge into reuse_scope.salt.
        ...
        elif cache_salt_id is not None:
            assert reuse_scope.salt in (None, cache_salt_id), (
                "cache_salt_id conflicts with ReuseScope.salt"
            )
            reuse_scope = reuse_scope._replace(salt=cache_salt_id)
