...
class AttentionLayerConfig:
    ...
    @property
    def _residency_group(self) -> int:
        """C++ backend: separate otherwise-identical lifecycle groups."""
    @_residency_group.setter
    def _residency_group(self, value: int) -> None: ...
    @property
...
class HostSourceView:
    ...
    Arrays are read-only NumPy views. *_address properties are CUDA addresses.
    Use a host-source read scope for GPU access. This view owns no storage.
    """
    @property
    ...
    @property
    def request_ids(self) -> Any: ...
    @property
    def request_ids_address(self) -> int: ...
    @property
    def generations(self) -> Any: ...
    @property
    def generations_address(self) -> int: ...
    @property
    def request_valid(self) -> Any: ...
    @property
    def request_valid_address(self) -> int: ...
    @property
    def slot_ids(self) -> Any: ...
    @property
    def slot_ids_address(self) -> int: ...
    @property
    def host_levels(self) -> Any: ...
    @property
    def host_levels_address(self) -> int: ...
    @property
    def completed_tokens(self) -> Any: ...
    @property
    def completed_tokens_address(self) -> int: ...
    @property
    def pool_metadata(self) -> Any: ...
    @property
    def pool_metadata_address(self) -> int: ...

class _HostSourceRead:
    def close(self) -> None: ...
...
class _KVCache:
    ...
    def _set_residency_window(
        self, layer_group_id: LayerGroupId, window_size: int | None, num_sink_tokens: int = 0
    ) -> None:
        """C++ backend: hold cold full-history pages while locking sinks, window, and writes."""
