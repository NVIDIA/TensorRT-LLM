...
# not carry any gateway protobuf package. The single source of truth for each
# gateway pin lives here; the devel extra aggregates them so developers and CI
# get the adapters without a separate install step.
