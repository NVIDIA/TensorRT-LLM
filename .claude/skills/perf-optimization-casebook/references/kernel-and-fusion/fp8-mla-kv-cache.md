...
- **Prior art:** PR #3190. Files: `cpp/.../common/attentionOp.cpp` (`mFP8GenerationMLA`), `kernels/mlaKernels.cu`, `kernels/flashMLA/flash_fwd_mla_fp8_sm90.cu`, `_torch/modules/attention.py`. Owning specialist: **kernel-cuda-specialist**.
