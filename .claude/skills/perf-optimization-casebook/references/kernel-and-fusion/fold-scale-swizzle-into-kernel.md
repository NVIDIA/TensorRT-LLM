...
- **Prior art:** PR #6231. Files: `_torch/custom_ops/torch_custom_ops.py`, `_torch/moe/fused_moe/fused_moe_cutlass.py` (`swizzled_input_sf`), `cpp/.../thop/moe/cutlass/moeOp.cpp`, `kernels/moe/cutlass/moe_kernels.cu`. Owning specialist: **kernel-cuda-specialist**.
