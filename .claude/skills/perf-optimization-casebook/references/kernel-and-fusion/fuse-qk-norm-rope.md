...
- **Prior art:** PR #4611. Files: `_torch/modules/attention.py` (`apply_qk_norm_rope`), `modeling_qwen3.py`, `_torch/compilation/utils.py` (in-place reg). Owning specialist: **kernel-cuda-specialist**.
