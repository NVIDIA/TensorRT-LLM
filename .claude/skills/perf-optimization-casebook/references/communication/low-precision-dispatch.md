...
- **Prior art:** PRs #5881, #6296, #7927. Files: `_torch/moe/fused_moe/communication/deep_ep_low_latency.py`, `deep_ep_utils.py` (`low_latency_dispatch_fp4`, `low_latency_combine_low_precision`), `thop/moe/cutlass/moeOp.cpp`. Owning skill: **trtllm-moe-develop**; gate with **perf-sweep-challenger**.
