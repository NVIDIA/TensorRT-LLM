...
- **Prior art:** PRs #9695, #7977, #10043 (+WARs). Files: `cpp/.../common/envUtils.{cpp,h}` (`getEnvEnablePDL`, `launchWithPdlWhenEnabled`), `kernels/moe/cutlass/moe_kernels.cu`, `fusedLayernormKernels/*`, `mlaKernels.cu`, `fusedMoeCommKernels.cu`. Owning specialist: **kernel-cuda-specialist**.
