...
- **Prior art:** PR #3286. Files: `_torch/modules/attention.py` (MLA `forward`: nulling of `q`/`compressed_kv`/`k_pe`, `fused_q`, attention outputs, scale tensors). Detection: **perf-analysis** (memory).
