...
- **Prior art:** PR #8495. Files: `_torch/attention/mla.py`, `cpp/.../thop/dsv3RopeOp.cpp` (`mla_rope_generation`), `attention/backends/trtllm.py`. Related: the [shared/routed-expert overlap case](multi-stream-shared-routed-expert.md) (same `maybe_execute_in_parallel` pattern).
