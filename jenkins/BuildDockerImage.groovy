        ...
        stage("Build")
        {
            parallel {
                ...
                stage("Build x86_64-skip") {
                    ...
                    steps
                    {
                        buildImage("triton-devel", params.action, "skip")
                    }
                }
                ...
                stage("Build rockylinux8 x86_64-skip-py3.10") {
                    ...
                    steps
                    {
                        buildImage("rockylinux8", params.action, "skip", "PYTHON_VERSION=3.10.12 STAGE=triton-devel", "", "-py310")
                    }
                }
                stage("Build rockylinux8 x86_64-skip-py3.12") {
                    ...
                    steps
                    {
                        buildImage("rockylinux8", params.action, "skip", "PYTHON_VERSION=3.12.3 STAGE=triton-devel", "", "-py312")
                    }
                }
