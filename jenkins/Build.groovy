...
AGENT_IMAGE = "urm-rn.nvidia.com/sw-tensorrt-docker/tensorrt-llm:pytorch-25.01-py3-x86_64-ubuntu24.04-trt10.8.0.43-skip-devel-202502281350-8622"
...
def runLLMPackage(pipeline, archTriple, tarFileName, linuxPkgName)
{
    ...
    sh """cd ${llmPackage}/tensorrt_llm && \
        ...
        --lib_list oss \
        --clean \
        --replace ${llmPackage}/tensorrt_llm/jenkins/git_mirror.yaml \
