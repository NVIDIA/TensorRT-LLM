#!/usr/bin/env python3
"""
Script to execute SLURM disaggregated server tests.
This script parses the config YAML to determine hardware configuration,
then submits a SLURM batch job and monitors its execution.
"""
import subprocess
import sys
import yaml
...
"""
    ...
    tail_proc = subprocess.Popen(['tail', '-f', output_file], stdout=subprocess.PIPE, stderr=subprocess.PIPE)
