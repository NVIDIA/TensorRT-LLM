...
def remove_llmapi_launch(pytest_command):
    command_parts = pytest_command.split()
    filtered_parts = [part for part in command_parts if "trtllm-llmapi-launch" not in part]
...
def main():
    ...
    # Get pytest command without llmapi launch
    pytest_without_llmapi_command = remove_llmapi_launch(args.pytest_command)
