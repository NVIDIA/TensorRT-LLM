...
def launchTestJobs(pipeline, testFilter, dockerNode=null)
{
    ...
    parallelJobs = turtleConfigs.collectEntries{key, values -> [key, [trtllm_utils.createKubernetesPodConfig(LLM_DOCKER_IMAGE, values[0], "amd64", values[4] ?: 1, key.contains("Perf")), {
    ...
    if (env.targetArch == AARCH64_TRIPLE) {
        parallelJobs = aarch64Configs.collectEntries{key, values -> [key, [trtllm_utils.createKubernetesPodConfig(LLM_DOCKER_IMAGE, values[0], "arm64"), {
