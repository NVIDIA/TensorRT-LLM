...
def launchTestJobs(pipeline, testFilter)
{
    ...
    x86SlurmTestConfigs = [
        ...
        "A100X-Triton-Post-Merge-1": ["auto:dgx-a100-x1", "l0_a100", 1, 2],
        "A100X-Triton-Post-Merge-2": ["auto:dgx-a100-x1", "l0_a100", 2, 2],
        "A100X-FMHA-Post-Merge-1": ["auto:dgx-a100-x1", "l0_a100", 1, 1],
