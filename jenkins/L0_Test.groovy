...
def launchTestJobs(pipeline, testFilter)
{
    ...
    x86SlurmTestConfigs = [
        ...
        "DGX_B200-4_GPUs-PyTorch-Perf-Sanity-Post-Merge-1": ["b200-x4", "perf_sanity_l0_dgx_b200", 2, 1, 4],
        "DGX_B200-4_GPUs-PyTorch-Perf-Sanity-Post-Merge-1": ["b200-x4", "perf_sanity_l0_dgx_b200", 2, 2, 4],
