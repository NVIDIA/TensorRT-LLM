@Library(['bloom-jenkins-shared-lib@emma/debug_retry_cmd', 'trtllm-jenkins-shared-lib@main']) _
    ...
    try {
        ...
        withCredentials([
            ...
            stage('Prepare Testing') {
                ...
                //test for retry
                Utils.exec(pipeline, script: "sshpass -p '${remote.passw}' echo 'srun error: getaddrinfo() failed with dlcluster!!!!!' && exit 42", numRetries: 3,)
