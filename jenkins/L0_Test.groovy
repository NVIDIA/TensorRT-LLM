...
def launchTestJobs(pipeline, testFilter)
{
    ...
    // ]
    multiNodesSBSAConfigs = [:]
    def numPostMergeMultiNodeTests = 9
    multiNodesSBSAConfigs += (1..numMultiNodeTests).collectEntries { i ->
        ["GB200-8_GPUs-2_Nodes-PyTorch-Post-Merge-${i}".toString(), ["gb200-multi-node", "l0_gb200_multi_nodes", i, numPostMergeMultiNodeTests, 8, 2]]
    }
