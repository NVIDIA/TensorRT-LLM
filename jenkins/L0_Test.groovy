...
def launchTestJobs(pipeline, testFilter)
{
    ...
    x86SlurmTestConfigs = [
        ...
        // Temporary single-GPU B200 repro stage for the multimodal encoder flake.
        "DGX_B200-PyTorch-MMEncoder-Repro-1": ["auto:dgx-b200-flex", "l0_b200_mm_encoder_repro", 1, 1, 1, 1, true],
