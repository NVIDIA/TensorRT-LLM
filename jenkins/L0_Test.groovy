...
@Library(['bloom-jenkins-shared-lib@dev-mlefebvre-gcpiad', 'trtllm-jenkins-shared-lib@main']) _
...
def launchTestJobs(pipeline, testFilter, globalVars)
{
    ...
    SBSASlurmTestConfigs = [
        ...
        "GB200-4_GPUs-PyTorch-PerfSanity-1": ["gb200-x4-gcp-iad", "l0_gb200_multi_gpus_perf_sanity", 1, 2, 4],
        "GB200-4_GPUs-PyTorch-PerfSanity-2": ["gb200-x4-gcp-iad", "l0_gb200_multi_gpus_perf_sanity", 2, 2, 4],
        // PerfSanity post-merge tests
        "GB200-4_GPUs-PyTorch-PerfSanity-Post-Merge-1": ["gb200-x4-gcp-iad", "l0_gb200_multi_gpus_perf_sanity", 1, 4, 4],
        "GB200-4_GPUs-PyTorch-PerfSanity-Post-Merge-2": ["gb200-x4-gcp-iad", "l0_gb200_multi_gpus_perf_sanity", 2, 4, 4],
        "GB200-4_GPUs-PyTorch-PerfSanity-Post-Merge-3": ["gb200-x4-gcp-iad", "l0_gb200_multi_gpus_perf_sanity", 3, 4, 4],
        "GB200-4_GPUs-PyTorch-PerfSanity-Post-Merge-4": ["gb200-x4-gcp-iad", "l0_gb200_multi_gpus_perf_sanity", 4, 4, 4],
