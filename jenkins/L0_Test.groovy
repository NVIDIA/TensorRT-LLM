...
def launchTestJobs(pipeline, testFilter)
{
    ...
    x86SlurmTestConfigs = [
        ...
        "DGX_B200-4_GPUs-PyTorch-1": ["b200-x4", "l0_dgx_b200", 1, 1, 4, 1, true],
        "DGX_B200-4_GPUs-PyTorch-Ray-1": ["b200-x4", "l0_dgx_b200", 1, 1, 4, 1, true],
        "DGX_B200-4_GPUs-AutoDeploy-1": ["b200-x4", "l0_dgx_b200", 1, 1, 4, 1, true],
        "DGX_B200-8_GPUs-PyTorch-1": ["b200-x8", "l0_dgx_b200", 1, 1, 8, 1, true],
        "DGX_B200-4_GPUs-PyTorch-Post-Merge-1": ["b200-x4", "l0_dgx_b200", 1, 2, 4, 1, true],
        "DGX_B200-4_GPUs-PyTorch-Post-Merge-2": ["b200-x4", "l0_dgx_b200", 2, 2, 4, 1, true],
