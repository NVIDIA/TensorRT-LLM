...
def createKubernetesPodConfig(image, type, arch = "amd64", gpuCount = 1, perfMode = false)
{
    ...
    default:
        ...
        if (type == "b100-ts2" || type.contains("dgx-h100") || type.contains("dgx-h200") || type == "gh200" || type == "rtx-5080" || type == "rtx-5090" ) {
            selectors = """
                    kubernetes.io/arch: ${arch}
                    kubernetes.io/os: linux
...
def launchTestJobs(pipeline, testFilter, dockerNode=null)
{
    ...
    turtleConfigs = [
        ...
        "GB202-PyTorch-1": ["rtx-5090", "l0_gb202", 1, 1],
        "GB203-TensorRT-1": ["rtx-5080", "l0_gb203", 1, 3],
        "GB203-TensorRT-2": ["rtx-5080", "l0_gb203", 2, 3],
        "GB203-TensorRT-3": ["rtx-5080", "l0_gb203", 3, 3],
