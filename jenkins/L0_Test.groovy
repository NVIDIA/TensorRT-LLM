...
def launchTestJobs(pipeline, testFilter, globalVars)
{
    ...
    SBSASlurmTestConfigs = [
        ...
        "GB300-4_GPUs-PyTorch-PerfSanity-1": ["auto:gb300-x4", "l0_gb300_multi_gpus_perf_sanity", 1, 2, 4, 1, true, false],
        "GB300-4_GPUs-PyTorch-PerfSanity-2": ["auto:gb300-x4", "l0_gb300_multi_gpus_perf_sanity", 2, 2, 4, 1, true, false],
        // PerfSanity post-merge tests
    ...
    // PerfSanity pre-merge disaggregated
    // 2 Nodes
    multiNodesSBSAConfigs += buildStageConfigs(
    ...
    // 3 Nodes (pre-merge)
    multiNodesSBSAConfigs += buildStageConfigs(
        "GB300-12_GPUs-3_Nodes-PyTorch-Disagg-PerfSanity-CTX1-NODE1-GPU2-GEN1-NODE2-GPU8",
        "auto:gb300-flex",
    ...
    multiNodesSBSAConfigs += buildStageConfigs(
        "GB300-36_GPUs-9_Nodes-PyTorch-Disagg-PerfSanity-CTX1-NODE1-GPU4-GEN4-NODE2-GPU8",
        "gb300-flex-aws-cmh",
    ...
    multiNodesSBSAConfigs += buildStageConfigs(
        "GB300-40_GPUs-10_Nodes-PyTorch-Disagg-PerfSanity-CTX6-NODE1-GPU4-GEN1-NODE4-GPU16",
        "auto:gb300-flex",
