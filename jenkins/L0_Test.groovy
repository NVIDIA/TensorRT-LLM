@Library(['bloom-jenkins-shared-lib@emma/block_bad_nodes_in_dlcluster', 'trtllm-jenkins-shared-lib@main']) _
...
def launchTestJobs(pipeline, testFilter)
{
    ...
    // ]
    multiNodesSBSAConfigs = [:]
    multiNodesSBSAConfigs += (1..3).collectEntries { i ->
        ["GB200-8_GPUs-2_Nodes-PyTorch-Post-Merge-${i}".toString(), ["gb200-multi-node", "l0_gb200_multi_nodes", i, 3, 8, 2]]
    }
