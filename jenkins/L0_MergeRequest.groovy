...
def getMultiGpuFileChanged(pipeline, testFilter, globalVars)
{
    ...
    def relatedFileList = [
        ...
        "cpp/tensorrt_llm/kernels/moe/communication/moeAllReduceFusionKernels",
        "cpp/tensorrt_llm/kernels/moe/communication/moeAlltoAll",
        "cpp/tensorrt_llm/kernels/moe/communication/moePrepareKernels",
