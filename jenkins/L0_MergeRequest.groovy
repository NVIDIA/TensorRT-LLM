...
def launchJob(jobName, reuseBuild, platform="x86_64", additionalParameters = [:]) {
        ...
        "x86_64-linux": {
            script {
                stage("Build") {
                    ...
                    launchJob("/LLM/helpers/Build-x86_64", reuseBuild, "x86_64", additionalParameters)
                }
                ...
                stage(testStageName) {
                    ...
                    try {
                        ...
                        launchJob("L0_Test-x86_64-Single-GPU", false, "x86_64", additionalParameters)
                    } catch (InterruptedException e) {
                        throw e
                    } catch (Exception e) {
                ...
                stage(testStageName) {
                    ...
                    try {
                        ...
                        launchJob("L0_Test-x86_64-Multi-GPU", false, "x86_64", additionalParameters)
            ...
            script {
                ...
                stage(testStageName) {
                    ...
                    try {
                        ...
                        launchJob("L0_Test-SBSA", false, "SBSA", additionalParameters)
        ...
        "Build-Docker-Images": {
            script {
                stage("[Build-Docker-Images] Remote Run") {
                    ...
                    launchJob("/LLM/helpers/BuildDockerImages", false, "x86_64", additionalParameters)
                }
            }
        }
    ]
