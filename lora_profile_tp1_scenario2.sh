...
echo "=== LoRA TRT gptManagerBenchmark TP=1 Scenario 2 Profiling ==="
echo "=============================================================="
...
# ============================================================================
# TP=1 Scenario 2: Engine WITH LoRA, Requests WITHOUT LoRA
# ============================================================================
...
nsys profile \
    ...
    --output=${EG_DIR}/profiles/scenario2-lora-engine-no-lora-requests-tp-${TP}/gpt_manager_scenario2_tp1 \
...
echo "Profile saved to: ${EG_DIR}/profiles/scenario2-lora-engine-no-lora-requests-tp-${TP}/gpt_manager_scenario2_tp1.nsys-rep"
echo ""
echo "To view the profile, run:"
echo "nsys-ui ${EG_DIR}/profiles/scenario2-lora-engine-no-lora-requests-tp-${TP}/gpt_manager_scenario2_tp1.nsys-rep"
