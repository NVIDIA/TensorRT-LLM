    ...
    bool computeLogProbs, bool normalizeLogProbs)
{
    ...
    auto inputs = tb::MakeDecodingBatchInputOutput::createDecoderBatchInputs(activeSlots, decoderInputs.logits,
        generatedTokensPerSteps, batchSize, maxGeneratedTokensPerStep, inputBuffers.forwardBatchSlots,
        decoderInputs.srcCacheIndirection);
