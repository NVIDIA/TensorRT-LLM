...
TEST(MPIUtils, AsyncSendCanBePolled)
{
    ...
    auto request = comm.sendAsync(&sentValue, 1, mpi::MpiType::kUINT64, destination, mpi::MpiTag::kContextTransferVote);
    static_cast<void>(comm.recv(&receivedValue, 1, mpi::MpiType::kUINT64, source, mpi::MpiTag::kContextTransferVote));
