...
public:
    ...
    void verify(int token_num, int hidden_dim)
    {
        ...
        if constexpr (ar_fusion::GetQuantType<Pattern> == ar_fusion::QuantType::kFP4)
        {
            ...
            static_assert(Pattern == ar_fusion::AllReduceFusionPattern::kARResidualRMSNormFP4QuantV2);
            // SF layout was packed to [numMTiles, numKTiles, 32 (mTile), 4 (mTile), 4(kTile)]
        ...
        {
            // We need norm out to verify the accuracy of quantization.
            static_assert(Pattern == ar_fusion::AllReduceFusionPattern::kARResidualRMSNormFP8QuantV2);
...
#define TEST_AR_FUSION(DType, FusionPattern)                                                                           \
    ...
    for (auto hidden_dim : candidate_hidden_dim)
    {
        ...
        TEST_AR_FUSION(half, ar_fusion::AllReduceFusionPattern::kARResidualRMSNormFP8QuantV2);
        TEST_AR_FUSION(__nv_bfloat16, ar_fusion::AllReduceFusionPattern::kARResidualRMSNormFP8QuantV2);
        TEST_AR_FUSION(float, ar_fusion::AllReduceFusionPattern::kARResidualRMSNormFP8QuantV2);
        TEST_AR_FUSION(half, ar_fusion::AllReduceFusionPattern::kARResidualRMSNormFP4QuantV2);
        TEST_AR_FUSION(__nv_bfloat16, ar_fusion::AllReduceFusionPattern::kARResidualRMSNormFP4QuantV2);
    }
