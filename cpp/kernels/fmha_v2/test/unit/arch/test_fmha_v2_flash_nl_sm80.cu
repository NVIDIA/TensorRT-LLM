...
using Kernel_traits_nl = fmha::Kernel_traits_v2<fmha::Ampere_hmma_fp16_traits,
                                                16,
                                                160,
                                                64,
                                                4,
...
void run_fmha_v2_flash_attention_fp16_64_16_S_160_sm80_nl(
    ...
    if( smem_size >= 48 * 1024 ) {
        FMHA_CHECK_CUDA(
            cudaFuncSetAttribute(fmha_v2_flash_attention_fp16_64_16_S_160_sm80_kernel_nl,
    ...
    fmha_v2_flash_attention_fp16_64_16_S_160_sm80_kernel_nl<<<grid,
...
TEST(FMHA_v2_FlashAttention_nl, InvalidConfig) {
    run_fmha_v2_flash_attention_fp16_64_16_S_160_sm80_nl(
        bert::Fused_multihead_attention_params_v2{}, cudaStream_t{});
