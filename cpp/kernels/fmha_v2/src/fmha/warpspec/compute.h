...
struct Compute
{
    ...
    static constexpr int SAGE_BLOCK_SIZE_K = Kernel_traits::SAGE_BLOCK_SIZE_K;

    static constexpr int SAGE_BLOCK_SIZE_V = Kernel_traits::SAGE_BLOCK_SIZE_V;
    ...
    static constexpr int SAGE_Q_TOKENS_PER_SCALE = 2;

    static constexpr int SAGE_K_TOKENS_PER_SCALE = STEP_KV / (4 * Kernel_traits::SAGE_K_CHUNKS);

    static constexpr int SAGE_Q_SCALES_PER_TILE = STEP_Q / SAGE_Q_TOKENS_PER_SCALE;

    static constexpr int SAGE_K_SCALES_PER_TILE = 4 * Kernel_traits::SAGE_K_CHUNKS;
    ...
    static constexpr int SAGE_Q_SLOTS_PER_SEQ = SAGE_Q_SCALES_PER_TILE;
    ...
    static constexpr int SAGE_K_SLOTS_PER_SEQ = SAGE_K_SCALES_PER_TILE + 4;
