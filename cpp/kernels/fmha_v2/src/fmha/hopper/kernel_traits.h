...
template<
    ...
    template<typename, typename, int, int, int, int, bool, bool, int>
    class Gmem_tile_qkv_,
    // The tma global memory tile for Q, K and V.
    template<typename, typename, int, int, int, bool, bool, int>
    class Gmem_tile_tma_qkv_,
...
struct FMHA_kernel_traits_hopper {
    ...
    using Gmem_tile_ldgsts_q = Gmem_tile_qkv_<Traits_p,
                                              Cta_tile_p,
    ...
    using Gmem_tile_tma_q = Gmem_tile_tma_qkv_<Traits_p,
                                               Cta_tile_p,
                                               Traits_p::BITS_PER_ELEMENT_A,
                                               STEP,
                                               D,
    ...
    using Smem_tile_ldgsts_q = fmha::Smem_tile_hopper_a<Traits_p,
                                                        Cta_tile_p,
                                                        Q_layout,
                                                        16,
                                                        BUFFERS_PER_SMEM_TILE_Q,
                                                        GMMA_DESC_MODE_Q,
                                                        USE_TMA_Q,
                                                        GMMA_Q_RF>;

    // The shared memory tile to swizzle Q. TODO: need to update to XMMA.
    using Smem_tile_tma_q = fmha::wip::Smem_tile_hopper_a<Traits_p,
                                                          Cta_tile_p,
                                                          Q_layout,
                                                          BUFFERS_PER_SMEM_TILE_Q,
                                                          GMMA_DESC_MODE_Q,
    ...
    // Hopefully we don't need to specialize for hopper.
    using Gmem_tile_ldgsts_k = Gmem_tile_qkv_<Traits_p,
                                              Cta_tile_p,
    ...
    using Gmem_tile_tma_k = Gmem_tile_tma_qkv_<Traits_p,
                                               Cta_tile_p,
                                               Traits_p::BITS_PER_ELEMENT_B,
                                               S,
                                               D,
    ...
    using Smem_tile_ldgsts_k = fmha::Smem_tile_hopper_b<Traits_p,
                                                        Cta_tile_p,
                                                        K_layout,
                                                        16,
                                                        BUFFERS_PER_SMEM_TILE_K,
                                                        GMMA_DESC_MODE_K,
                                                        USE_TMA_K>;

    using Smem_tile_tma_k = fmha::wip::Smem_tile_hopper_b<Traits_p,
                                                          Cta_tile_p,
                                                          K_layout,
                                                          BUFFERS_PER_SMEM_TILE_K,
                                                          GMMA_DESC_MODE_K,
    ...
    using Gmem_tile_ldgsts_v = Gmem_tile_qkv_<Traits_o,
                                              Cta_tile_o,
    ...
    using Gmem_tile_tma_v = Gmem_tile_tma_qkv_<Traits_o,
                                               Cta_tile_o,
                                               Traits_o::BITS_PER_ELEMENT_B,
                                               S,
                                               D,
    ...
    using Smem_tile_ldgsts_v = fmha::Smem_tile_v<Traits_o,
                                                 Cta_tile_o,
                                                 1,     // BUFFERS_PER_TILE
                                                 GMMA_DESC_MODE_V,
                                                 false  // USE_TMA_V
    ...
    using Smem_tile_tma_v = fmha::wip::Smem_tile_hopper_b<Traits_o,
                                                          Cta_tile_o,
                                                          V_layout,
                                                          BUFFERS_PER_SMEM_TILE_V,
                                                          GMMA_DESC_MODE_V,
                                                          GMMA_V_RF,
                                                          USE_LDGSTS_V>;
    ...
    using Compute_tile_o = fmha::Compute_tile_with_gmma<
        Traits_o,
        //TODO TMA path?
        Cta_tile_o,
...
template<
    ...
    // The flags.
    uint32_t FLAGS = 0x8>
using FMHA_kernel_traits_hopper_v2 = FMHA_kernel_traits_hopper<
    Traits_p,
    Traits_o,
    fmha::v2::Gmem_tile_qkv,  // hopefully we don't need to specialize for hopper ldgsts
    fmha::v2::Gmem_tile_tma_qkv,
    fmha::v2::Gmem_tile_o,
    S,
    D,
    STEP,
