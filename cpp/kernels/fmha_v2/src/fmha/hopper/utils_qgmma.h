...
inline __device__ void qgmma_e4m3_e4m3_fp32(uint64_t desc_a, uint64_t desc_b, uint32_t (&acc)[N / 2])
{
...
template <int N, bool /*ignored*/>
inline __device__ void qgmma_rfa_e4m3_e4m3_fp32(uint32_t const (&a)[4], uint64_t desc_b, uint32_t (&acc)[N / 2])
{
...
template <int N, bool /*ignored*/>
inline __device__ void qgmma_e4m3_e5m2_fp32(uint64_t desc_a, uint64_t desc_b, uint32_t (&acc)[N / 2])
{
...
template <int N, bool /*ignored*/>
inline __device__ void qgmma_rfa_e4m3_e5m2_fp32(uint32_t const (&a)[4], uint64_t desc_b, uint32_t (&acc)[N / 2])
{
...
template <int N, bool /*ignored*/>
inline __device__ void qgmma_e5m2_e4m3_fp32(uint64_t desc_a, uint64_t desc_b, uint32_t (&acc)[N / 2])
{
...
template <int N, bool /*ignored*/>
inline __device__ void qgmma_rfa_e5m2_e4m3_fp32(uint32_t const (&a)[4], uint64_t desc_b, uint32_t (&acc)[N / 2])
{
...
template <int N, bool /*ignored*/>
inline __device__ void qgmma_e5m2_e5m2_fp32(uint64_t desc_a, uint64_t desc_b, uint32_t (&acc)[N / 2])
{
...
template <int N, bool /*ignored*/>
inline __device__ void qgmma_rfa_e5m2_e5m2_fp32(uint32_t const (&a)[4], uint64_t desc_b, uint32_t (&acc)[N / 2])
{
