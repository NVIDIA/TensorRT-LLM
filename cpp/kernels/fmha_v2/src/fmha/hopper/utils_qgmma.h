...
qgmma_e4m3_e4m3_fp32(uint64_t desc_a, uint64_t desc_b, uint32_t (&acc)[N / 2]) {
...
template<int N, bool /*ignored*/>
inline __device__ void
qgmma_rfa_e4m3_e4m3_fp32(const uint32_t (&a)[4], uint64_t desc_b, uint32_t (&acc)[N / 2]) {
...
template<int N, bool /*ignored*/>
inline __device__ void
qgmma_e4m3_e5m2_fp32(uint64_t desc_a, uint64_t desc_b, uint32_t (&acc)[N / 2]) {
...
struct Qgmma_rfa_e4m3_e5m2_fp32<160> {
    static inline __device__ void
    mma(const uint32_t (&a)[4], uint64_t desc_b, uint32_t (&acc)[80]) {
#if defined(__CUDA_ARCH__) && __CUDA_ARCH__ >= 900 && defined(__CUDA_ARCH_FEAT_SM90_ALL)
        asm volatile("wgmma.mma_async.sync.aligned.m64n160k32.f32.e4m3.e5m2\n"
                     "{\n"
                     "    %0,   %1,   %2,   %3,   %4,   %5,   %6,   %7,\n"
...
template<int N, bool /*ignored*/>
inline __device__ void
qgmma_rfa_e4m3_e5m2_fp32(const uint32_t (&a)[4], uint64_t desc_b, uint32_t (&acc)[N / 2]) {
...
template<int N, bool /*ignored*/>
inline __device__ void
qgmma_e5m2_e4m3_fp32(uint64_t desc_a, uint64_t desc_b, uint32_t (&acc)[N / 2]) {
...
template<int N, bool /*ignored*/>
inline __device__ void
qgmma_rfa_e5m2_e4m3_fp32(const uint32_t (&a)[4], uint64_t desc_b, uint32_t (&acc)[N / 2]) {
...
template<int N, bool /*ignored*/>
inline __device__ void
qgmma_e5m2_e5m2_fp32(uint64_t desc_a, uint64_t desc_b, uint32_t (&acc)[N / 2]) {
...
template<int N, bool /*ignored*/>
inline __device__ void
qgmma_rfa_e5m2_e5m2_fp32(const uint32_t (&a)[4], uint64_t desc_b, uint32_t (&acc)[N / 2]) {
