...
template<
    ...
    template<typename, typename, int, int, int, int, bool, bool, int, bool>
    class Gmem_tile_q_,
    template<typename, typename, int, int, int, int, bool, bool, int, bool>
    class Gmem_tile_k_,
    template<typename, typename, int, int, int, int, bool, bool, int, bool>
    ...
    int SAGE_BLOCK_SIZE_Q_ = 0,
    int SAGE_BLOCK_SIZE_K_ = 0,
    int SAGE_BLOCK_SIZE_V_ = 0>
struct Kernel_traits_ {
    ...
    using Gmem_tile_k = Gmem_tile_k_<Traits_p,
                                     Cta_tile_p,
...
using Kernel_traits_v2 = Kernel_traits_<Traits,
                                        ...
                                        fmha::v2::Gmem_tile_qkv,
                                        fmha::v2::Gmem_tile_qkv,
                                        Gmem_tile_o_dispatcher<Traits, OutputType>::Gmem_tile_o,
                                        S,
                                        D,
                                        DV,
                                        STEP,
