...
struct Gmem_tile_o<fmha::Volta_hmma_fp16_16x16x16_traits, Cta_tile, CTAS_PER_HEAD>
    ...
    template<typename Params, typename Block_info>
    inline __device__
    Gmem_tile_o(const Params &params, const Block_info &binfo, int tidx, int cta_row_offset = 0)
...
struct Imma_gmem_tile_o {
    ...
    inline __device__ Imma_gmem_tile_o(const Params &params, int bidx, int tidx, int cta_row_offset)
        : params_o_stride_in_bytes_(params.o_stride_in_bytes),
