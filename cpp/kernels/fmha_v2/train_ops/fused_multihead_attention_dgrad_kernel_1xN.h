...
inline __device__ void compute_dv_1xN(Params const& params)
{
...
template <typename Kernel_traits, typename Params>
inline __device__ void compute_dq_dk_1xN(Params const& params)
{
