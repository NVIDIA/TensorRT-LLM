...
using Kernel_traits = fmha::Kernel_traits_v2<fmha::Ampere_hmma_fp32_traits, 384, 64, 16, 1, 8, 1, 0x28u>;
static_assert(!Kernel_traits::HEADS_INTERLEAVED);

extern "C" __global__ void fmha_dgrad_v2_fp16_384_64_sm80_kernel(Fused_multihead_attention_fprop_params params)
{
...
void run_fmha_dgrad_v2_fp16_384_64_sm80(Fused_multihead_attention_fprop_params const& params, cudaStream_t stream)
{
    ...
    if (smem_size >= 48 * 1024)
    {
        FMHA_CHECK_CUDA(cudaFuncSetAttribute(
            fmha_dgrad_v2_fp16_384_64_sm80_kernel, cudaFuncAttributeMaxDynamicSharedMemorySize, smem_size));
    }

    dim3 grid(params.h, params.b);
    fmha_dgrad_v2_fp16_384_64_sm80_kernel<<<grid, Kernel_traits::THREADS, smem_size, stream>>>(params);
}
