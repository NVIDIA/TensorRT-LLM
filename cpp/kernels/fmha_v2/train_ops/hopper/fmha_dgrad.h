...
struct Fmha_dgrad_params {
    ...
    Fmha_dgrad_params(void *dqkv_ptr_,
                      void *qkv_ptr_,
                      void *do_ptr_,
                      void *o_ptr_,
                      float *m_ptr_,
                      ...
                      int d_,
                      float p_dropout,
                      float scale_bmm_q_k_,
                      float *ptr_d_scale_qkv_,
                      float *ptr_d_scale_s_,
                      float *ptr_d_scale_o_,
                      float *ptr_d_scale_do_,
                      float *ptr_d_scale_dp_,
                      float *ptr_d_scale_dqkv_,
                      float *ptr_q_scale_s_,
                      float *ptr_q_scale_dp_,
                      float *ptr_q_scale_dqkv_,
                      uint64_t *ptr_philox_unpacked_)
        : dqkv_ptr(dqkv_ptr_), qkv_ptr(qkv_ptr_), do_ptr(do_ptr_), o_ptr(o_ptr_), m_ptr(m_ptr_),
          zi_ptr(zi_ptr_), cu_seqlens(cu_seqlens_), amax_dp(amax_dp_), amax_dqkv(amax_dqkv_),
          dq_tmp_ptr(dq_tmp_ptr_), b(b_), s(s_), h(h_), d(d_), p_keep(1.f - p_dropout),
          rp_keep(1.f / (1.f - p_dropout)), scale_bmm_q_k(scale_bmm_q_k_),
          ptr_d_scale_qkv(ptr_d_scale_qkv_), ptr_d_scale_s(ptr_d_scale_s_),
          ptr_d_scale_o(ptr_d_scale_o_), ptr_d_scale_do(ptr_d_scale_do_),
          ptr_d_scale_dp(ptr_d_scale_dp_), ptr_d_scale_dqkv(ptr_d_scale_dqkv_),
          ptr_q_scale_s(ptr_q_scale_s_), ptr_q_scale_dp(ptr_q_scale_dp_),
          ptr_q_scale_dqkv(ptr_q_scale_dqkv_), ptr_philox_unpacked(ptr_philox_unpacked_) {
    }
...
struct Launch_params_ {
    ...
    Launch_params_(cudaDeviceProp *props_,
                   cudaStream_t stream_,
                   Params params_,
                   bool all_e5m2_ = false)
        : props(props_), stream(stream_), params(params_), all_e5m2(all_e5m2_) {
    }
...
void run_fmha_dgrad_fp8_512_64_sm90(Launch_params &launch_params, const bool configure);
