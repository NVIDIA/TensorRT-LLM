...
struct Fmha_fprop_params {
    ...
    Fmha_fprop_params(void *qkv_ptr_,
                      void *o_ptr_,
                      float *m_ptr_,
                      float *zi_ptr_,
                      int *cu_seqlens_,
                      ...
                      float *ptr_q_scale_o_,
                      uint64_t *ptr_philox_unpacked_)
        : qkv_ptr(qkv_ptr_), o_ptr(o_ptr_), m_ptr(m_ptr_), zi_ptr(zi_ptr_), cu_seqlens(cu_seqlens_),
          amax_s(amax_s_), amax_o(amax_o_), b(b_), s(s_), h(h_), d(d_), p_keep(1.f - p_dropout),
          rp_keep(1.f / (1.f - p_dropout)), scale_bmm_q_k(scale_bmm_q_k_),
          ptr_d_scale_qkv(ptr_d_scale_qkv_), ptr_d_scale_s(ptr_d_scale_s_),
          ptr_d_scale_o(ptr_d_scale_o_), ptr_q_scale_s(ptr_q_scale_s_),
          ptr_q_scale_o(ptr_q_scale_o_), ptr_philox_unpacked(ptr_philox_unpacked_) {
    }
