...
// P  = Q   x K'
using Traits_p =
    fmha::Hopper_qgmma_fp8_fp32_traits<64, 64, 32, false, false, e4m3_t, e4m3_t, e4m3_t>;
// T  = dO  x O'
using Traits_t =
    fmha::Hopper_qgmma_fp8_fp32_traits<64, 64, 32, false, false, e4m3_t, e4m3_t, e4m3_t>;
// dS = dO  x V'
...
// dQ = dP  x K
using Traits_dq =
    fmha::Hopper_qgmma_fp8_fp32_traits<64, 64, 32, true, false, e5m2_t, e4m3_t, e4m3_t>;
// dK = dP' x Q
using Traits_dk =
    fmha::Hopper_qgmma_fp8_fp32_traits<64, 64, 32, true, false, e5m2_t, e4m3_t, e4m3_t>;
// dV = S'  x dO
using Traits_dv =
    fmha::Hopper_qgmma_fp8_fp32_traits<64, 64, 32, true, false, e4m3_t, e4m3_t, e4m3_t>;
...
using Kernel_traits = fmha::hopper::Kernel_traits_dgrad<Traits_p,
                                                        Traits_t,
                                                        Traits_ds,
                                                        Traits_dq,
                                                        Traits_dk,
...
// T = dO   x O'
using Traits_t =
    fmha::Hopper_qgmma_fp8_fp32_traits<64, 64, 32, false, false, e5m2_t, e4m3_t, e5m2_t>;
// dS = dO  x V'
using Traits_ds =
    fmha::Hopper_qgmma_fp8_fp32_traits<64, 64, 32, false, false, e5m2_t, e4m3_t, e5m2_t>;
// dQ = dP  x K
using Traits_dq =
    fmha::Hopper_qgmma_fp8_fp32_traits<64, 64, 32, true, false, e5m2_t, e4m3_t, e5m2_t>;
// dK = dP' x Q
using Traits_dk =
    fmha::Hopper_qgmma_fp8_fp32_traits<64, 64, 32, true, false, e5m2_t, e4m3_t, e5m2_t>;
// dV = S'  x dO
using Traits_dv =
    fmha::Hopper_qgmma_fp8_fp32_traits<64, 64, 32, true, false, e4m3_t, e5m2_t, e5m2_t>;
...
__global__ __launch_bounds__(Kernel_traits::THREADS, 2) void fmha_dgrad_fp8_sm90_kernel(
    const __grid_constant__ Fmha_dgrad_params params) {
