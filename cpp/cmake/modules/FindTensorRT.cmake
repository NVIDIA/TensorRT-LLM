...
find_library(TensorRT_LIBRARY NAMES "nvinfer_${TensorRT_VERSION_MAJOR}" nvinfer)
...
if(TensorRT_FIND_COMPONENTS)
  ...
  if("OnnxParser" IN_LIST TensorRT_FIND_COMPONENTS)
    find_path(TensorRT_OnnxParser_INCLUDE_DIR NAMES NvOnnxParser.h)
  ...
  if("Plugin" IN_LIST TensorRT_FIND_COMPONENTS)
    find_path(TensorRT_Plugin_INCLUDE_DIR NAMES NvInferPlugin.h)

    find_library(
      TensorRT_Plugin_LIBRARY NAMES "nvinfer_plugin_${TensorRT_VERSION_MAJOR}"
                                    nvinfer_plugin)
