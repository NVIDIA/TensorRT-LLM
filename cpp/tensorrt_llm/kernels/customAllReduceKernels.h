...
enum class AllReduceFusionOp : int8_t
{
    ...
    RMS_NORM = 9,
    // As RESIDUAL_RMS_NORM_OUT_QUANT_NVFP4, but emits the block scale factors in LINEAR
    // (row-major) layout instead of SWIZZLED, as the trtllm-gen MoE kernels require.
