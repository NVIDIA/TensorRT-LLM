    ...
    {                                                                                                                  \
        ...
        {                                                                                                              \
            return reinterpret_cast<void*>(                                                                            \
                llama4_gemv_attn_scaling_per_block_kernel<HIDDEN_IN, 1, TILE_OUT, ALIGNED>);                           \
        }                                                                                                              \
        if (TILE_TOKEN == 2)                                                                                           \
        {                                                                                                              \
            return reinterpret_cast<void*>(                                                                            \
                llama4_gemv_attn_scaling_per_block_kernel<HIDDEN_IN, 2, TILE_OUT, ALIGNED>);                           \
        }                                                                                                              \
        if (TILE_TOKEN == 3)                                                                                           \
        {                                                                                                              \
            return reinterpret_cast<void*>(                                                                            \
                llama4_gemv_attn_scaling_per_block_kernel<HIDDEN_IN, 3, TILE_OUT, ALIGNED>);                           \
        }                                                                                                              \
        if (TILE_TOKEN == 4)                                                                                           \
        {                                                                                                              \
            return reinterpret_cast<void*>(                                                                            \
