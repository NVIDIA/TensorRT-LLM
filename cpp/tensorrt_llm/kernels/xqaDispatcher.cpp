...
size_t XqaDispatcher::getWorkspaceSize(
    int max_num_tokens, int max_num_sequences, int max_attention_window_size, bool forceSingleBlockMla)
{
    ...
    {
        int const multi_block_count = forceSingleBlockMla
            ? 1
