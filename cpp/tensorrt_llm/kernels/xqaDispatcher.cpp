...
void XqaDispatcher::runImpl(XQAParams params, KVCacheBuffer const& kv_cache_buffer)
{
    if (mUseTllmGen)
    {
        ...
        unsigned int head_size = params.head_size;
        ...
        QKVPreprocessingParams<T, KVCacheBuffer> preprocessingParms{static_cast<T*>(const_cast<void*>(params.qkv)),
            nullptr, nullptr, static_cast<T*>(xqa_q_input_ptr), kv_cache_buffer, static_cast<T const*>(params.qkv_bias),
            ...
            /* cu_kv_seqlens */ nullptr, launchParams.rotary_inv_freq_buf, params.rotary_cos_sin,
            params.kv_scale_orig_quant, params.spec_decoding_position_offsets, (float2 const*) nullptr,
