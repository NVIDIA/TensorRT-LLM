...
struct HalfVector
{
    ...
    __device__ __forceinline__ HalfVector(uint4 val)
        : data(val)
    {
    }

    __device__ __forceinline__ HalfVector()
        : data({0, 0, 0, 0})
    {
    }

    __device__ __forceinline__ HalfVector(int)
        : data({0, 0, 0, 0})
    {
...
struct BFloat16Vector
{
    ...
    __device__ __forceinline__ BFloat16Vector(uint4 val)
        : data(val)
    {
    }

    __device__ __forceinline__ BFloat16Vector()
        : data({0, 0, 0, 0})
    {
    }

    __device__ __forceinline__ BFloat16Vector(int)
        : data({0, 0, 0, 0})
    {
    } // For {0} initialization
};
...
struct FP8E5M2x4Vector
{
    ...
    __device__ __forceinline__ FP8E5M2x4Vector(uint4 val)
        : data(val)
    {
    }

    __device__ __forceinline__ FP8E5M2x4Vector()
        : data({0, 0, 0, 0})
    {
    }

    __device__ __forceinline__ FP8E5M2x4Vector(int)
        : data({0, 0, 0, 0})
    {
    } // For {0} initialization
};
...
struct FP8E4M3x4Vector
{
    ...
    __device__ __forceinline__ FP8E4M3x4Vector(uint4 val)
        : data(val)
    {
    }

    __device__ __forceinline__ FP8E4M3x4Vector()
        : data({0, 0, 0, 0})
    {
    }

    __device__ __forceinline__ FP8E4M3x4Vector(int)
        : data({0, 0, 0, 0})
    {
    } // For {0} initialization
};
