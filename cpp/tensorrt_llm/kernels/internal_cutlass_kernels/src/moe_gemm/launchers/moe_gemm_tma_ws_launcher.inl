...
#define INSTANTIATE_TMA_WARP_SPECIALIZED_MOE_GEMM(ArchTag_, DataType_, WeightType_, OutputType_, EpilogueTag_,                                                                                                                         \
    ...
    {                                                                                                                                                                                                                                  \
        ...
        {                                                                                                                                                                                                                              \
            ...
            { */                                                                                                                                                                                                                       \
            using Arch = ArchTag;                                                                                                                                                                                                      \
            constexpr static bool IsSM100 = Arch::kMinComputeCapability >= 100;                                                                                                                                                        \
                                                                                                                                                                                                                                       \
            ...
            static_assert(!IsFP4 || IsSM100, "FP4 is only supported by SM100");                                                                                                                                                        \
                                                                                                                                                                                                                                       \
            constexpr static bool IsFP8 = cutlass::platform::is_same<T, SafeFP8>::value;                                                                                                                                               \
                                                                                                                                                                                                                                       \
            constexpr static bool IsBlockScaled = IsFP4;                                                                                                                                                                               \
            static_assert(!IsBlockScaled || IsSM100, "Block scaled is only implemented for SM100");                                                                                                                                    \
                                                                                                                                                                                                                                       \
            ...
            using ElementABlockScaled = cute::tuple<ElementA, ElementSF>;                                                                                                                                                              \
            using ElementBBlockScaled = cute::tuple<ElementB, ElementSF>;                                                                                                                                                              \
                                                                                                                                                                                                                                       \
            ...
            using EpilogueScheduleSM90 = cutlass::epilogue::PtrArrayNoSmemWarpSpecialized;                                                                                                                                             \
                                                                                                                                                                                                                                       \
            constexpr static bool Is2SM = IsSM100 && (cute::size<0>(ClusterShape{}) % 2) == 0;                                                                                                                                         \
            using EpilogueScheduleSM100 = std::conditional_t<Is2SM, cutlass::epilogue::PtrArrayTmaWarpSpecialized2Sm,                                                                                                                  \
                cutlass::epilogue::PtrArrayTmaWarpSpecialized1Sm>;                                                                                                                                                                     \
                                                                                                                                                                                                                                       \
            using EpilogueSchedule = std::conditional_t<IsSM100, EpilogueScheduleSM100, EpilogueScheduleSM90>;                                                                                                                         \
                                                                                                                                                                                                                                       \
            using EpilogueTileShapeSm90 = TileShape;                                                                                                                                                                                   \
            using EpilogueTileShapeSm100 = decltype(shape_div(TileShape{}, ClusterShape{}));                                                                                                                                           \
            using EpilogueTileShape = std::conditional_t<IsSM100, EpilogueTileShapeSm100, EpilogueTileShapeSm90>;                                                                                                                      \
                                                                                                                                                                                                                                       \
            ...
            using KernelScheduleSM100 = std::conditional_t<Is2SM,                                                                                                                                                                      \
                std::conditional_t<IsBlockScaled,                                                                                                                                                                                      \
                    cutlass::gemm::KernelPtrArrayTmaWarpSpecialized2SmBlockScaledOmmaVs16Sm100,                                                                                                                                        \
                    cutlass::gemm::KernelPtrArrayTmaWarpSpecialized2SmSm100>,                                                                                                                                                          \
                std::conditional_t<IsBlockScaled,                                                                                                                                                                                      \
                    cutlass::gemm::KernelPtrArrayTmaWarpSpecialized1SmBlockScaledOmmaVs16Sm100,                                                                                                                                        \
                    cutlass::gemm::KernelPtrArrayTmaWarpSpecialized1SmSm100>>;                                                                                                                                                         \
            using KernelSchedule = std::conditional_t<IsSM100, KernelScheduleSM100, KernelScheduleSM90>;                                                                                                                               \
                                                                                                                                                                                                                                       \
            using TensorOp = std::conditional_t<IsSM100 && IsBlockScaled, cutlass::arch::OpClassBlockScaledTensorOp,                                                                                                                   \
                cutlass::arch::OpClassTensorOp>;                                                                                                                                                                                       \
                                                                                                                                                                                                                                       \
            using MainloopElementA = std::conditional_t<IsSM100 && IsBlockScaled, ElementABlockScaled, ElementA>;                                                                                                                      \
            using MainloopElementB = std::conditional_t<IsSM100 && IsBlockScaled, ElementBBlockScaled, ElementB>;                                                                                                                      \
                                                                                                                                                                                                                                       \
            ...
            using MainloopTileShape = std::conditional_t<IsSM100, MainloopTileShapeSm100, MainloopTileShapeSm90>;                                                                                                                      \
                                                                                                                                                                                                                                       \
            ...
            {                                                                                                                                                                                                                          \
                if constexpr (IsSM100)                                                                                                                                                                                                 \
                {                                                                                                                                                                                                                      \
                    return construct_if_true<IsSM100, EpilogueScalars>(ElementAccumulator(1.f),                                                                                                                                        \
                ...
                {                                                                                                                                                                                                                      \
                    return construct_if_true<!IsSM100, EpilogueScalars>(tma_ws_input.alpha_scale_ptr_array);                                                                                                                           \
                }                                                                                                                                                                                                                      \
                else                                                                                                                                                                                                                   \
                {                                                                                                                                                                                                                      \
                    return construct_if_true<!IsSM100, EpilogueScalars>(ElementAccumulator(1.f),                                                                                                                                       \
            ...
            {                                                                                                                                                                                                                          \
                ...
                {                                                                                                                                                                                                                      \
                    ...
                    return construct_if_true<FUSION == EpilogueFusion::FINALIZE, EpilogueArguments>(                                                                                                                                   \
                        ...
                        epi_params                                                                                                                                                                                                     \
                            .ptr_expert_first_token_offset, /* Offset of this expert's token in the router scales */                                                                                                                   \
