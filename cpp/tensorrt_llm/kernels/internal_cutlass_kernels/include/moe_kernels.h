...
public:
    ...
    computeStridesTmaWarpSpecializedDispatch(int64_t const* expert_first_token_offset,
        ...
        TmaWarpSpecializedGroupedGemmInput::ElementSF const* fp4_act_flat2, QuantParams::FP4Inputs fp4_params,
        void const* bias1, void const* bias2, void* gemm1_output, void* gemm2_output, cudaStream_t stream)
        = 0;
    ...
    computeStridesTmaWarpSpecializedLowLatencyDispatch(TmaWarpSpecializedGroupedGemmInput layout_info1,
        ...
        TmaWarpSpecializedGroupedGemmInput::ElementSF const* fc2_fp4_act_flat, QuantParams::FP4Inputs fp4_input,
...
public:
    ...
    computeStridesTmaWarpSpecializedDispatch(int64_t const* expert_first_token_offset,
        ...
        TmaWarpSpecializedGroupedGemmInput::ElementSF const* fp4_act_flat1,
        TmaWarpSpecializedGroupedGemmInput::ElementSF const* fp4_act_flat2, QuantParams::FP4Inputs fp4_params,
        void const* bias1, void const* bias2, void* gemm1_output, void* gemm2_output, cudaStream_t stream) override
    {
        return Self::computeStridesTmaWarpSpecialized(expert_first_token_offset, layout_info1, layout_info2, num_tokens,
            ...
            alpha_scale_flat1, alpha_scale_flat2, fp4_act_flat1, fp4_act_flat2, fp4_params,
        ...
        int const* active_expert_global_ids, int start_expert, cudaStream_t stream) override
    {
        return Self::computeStridesTmaWarpSpecializedLowLatency(layout_info1, layout_info2, num_tokens, gemm1_n,
            ...
            fc2_fp4_act_flat, fp4_input, reinterpret_cast<ScaleBiasType const*>(bias1),
