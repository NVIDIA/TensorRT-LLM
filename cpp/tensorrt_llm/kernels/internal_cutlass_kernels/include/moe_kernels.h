...
public:
    ...
    computeStridesTmaWarpSpecializedDispatch(int64_t const* expert_first_token_offset,
        int64_t const* expert_first_sf_offset, TmaWarpSpecializedGroupedGemmInput layout_info1,
        ...
        void const* gemm1_in, void const* gemm2_in, void const* weights1, void const* weights2,
...
public:
        ...
        int* num_active_experts_per, int* active_expert_global_ids, int start_expert) override
    {
        ...
        return Self::gemm2(moe_gemm_runner_, block_scale_gemm_runner, static_cast<T const*>(input), gemm_output,
            ...
            experts_per_token, alpha_scale_ptr_array, use_lora, fc2_lora, stream, parallelism_config, config,
    ...
    {
        return Self::computeStridesTmaWarpSpecialized(expert_first_token_offset, expert_first_sf_offset, layout_info1,
            layout_info2, num_tokens, expanded_num_tokens, gemm1_n, gemm1_k, gemm2_n, gemm2_k, num_experts_per_node,
...
private:
    ...
    computeStridesTmaWarpSpecialized(int64_t const* expert_first_token_offset, int64_t const* expert_first_sf_offset,
...
public:
    ...
    std::map<std::string, std::pair<size_t, size_t>> getProfilerWorkspaces(int maxM, bool is_tma_ws, bool need_weights);
...
private:
    void prepareRouting(int num_tokens, char* workspace, bool need_weights, cudaStream_t stream);
    void prepareQuantParams(int num_tokens, char* workspace, bool need_weights, cudaStream_t stream);
