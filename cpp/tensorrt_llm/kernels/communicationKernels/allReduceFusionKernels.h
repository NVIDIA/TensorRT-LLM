...
enum class AllReduceFusionPattern : int
{
    ...
    // The difference between the V2 and the standard version is that the V2 version outputs the result of the norm.
    kARResidualRMSNormFP8QuantV2 = 4,
    kARResidualRMSNormFP4QuantV2 = 5
};
...
DEFINE_FUSION_PATTERN_TRAITS(
    AllReduceFusionPattern::kARResidualRMSNormFP8QuantV2, false, true, true, true, true, QuantType::kFP8);
DEFINE_FUSION_PATTERN_TRAITS(
    AllReduceFusionPattern::kARResidualRMSNormFP4QuantV2, false, true, true, true, true, QuantType::kFP4);
