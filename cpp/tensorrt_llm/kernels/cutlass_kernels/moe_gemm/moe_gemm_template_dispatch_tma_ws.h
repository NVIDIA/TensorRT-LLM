        ...
        auto getFunc = [&]()
        {
            if constexpr (std::is_same_v<T, __nv_fp8_e4m3> && std::is_same_v<WeightType, __nv_fp4_e2m1>)
            {
                ...
                return hopper_input.swap_ab
                    ? &tma_warp_specialized_generic_moe_gemm_kernelLauncher<Arch, T, WeightType, OutputType,
                        EpilogueTag, FUSION, TileShape, ClusterShape, true, false, true>
                    : &tma_warp_specialized_generic_moe_gemm_kernelLauncher<Arch, T, WeightType, OutputType,
                        EpilogueTag, FUSION, TileShape, ClusterShape, true, false, false>;
            }
            else
            {
                TLLM_CHECK_WITH_INFO(hopper_input.fpX_block_scaling_type
                ...
                return hopper_input.swap_ab
                    ? &tma_warp_specialized_generic_moe_gemm_kernelLauncher<Arch, T, WeightType, OutputType,
                        EpilogueTag, FUSION, TileShape, ClusterShape, false, false, true>
                    : &tma_warp_specialized_generic_moe_gemm_kernelLauncher<Arch, T, WeightType, OutputType,
                        EpilogueTag, FUSION, TileShape, ClusterShape, false, false, false>;
            }
        };
