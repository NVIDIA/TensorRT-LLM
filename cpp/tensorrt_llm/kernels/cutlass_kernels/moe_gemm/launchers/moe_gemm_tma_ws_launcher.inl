...
template <typename ArchTag, typename T, typename WeightType, typename OutputType, typename EpilogueTag,
    EpilogueFusion FUSION, typename TileShape, typename ClusterShape, bool IsMXFPX, bool BIAS, bool SwapAB>
    ...
    size_t* workspace_size)
{
    ...
    else
    {
        return DispatchToTmaWSFunction<ArchTag, T, WeightType, OutputType, EpilogueTag, FUSION, TileShape, ClusterShape,
            IsMXFPX, BIAS, SwapAB>::op(tma_ws_input, num_experts, multi_processor_count, stream, kernel_occupancy,
            workspace_size);
    }
}
...
#define INSTANTIATE_TMA_WARP_SPECIALIZED_MOE_GEMM(ArchTag_, DataType_, WeightType_, OutputType_, EpilogueTag_,                                                                                                                                                 \
    FUSION_, CTA_M_, CTA_N_, CTA_K_, CGA_M_, CGA_N_, CGA_K_, MXFPX_, BIAS_, SWAP_AB_)                                                                                                                                                                          \
    static void                                                                                                                                                                                                                                                \
        tma_warp_specialized_generic_moe_gemm_kernelLauncher_##ArchTag_##_##DataType_##_##WeightType_##_##OutputType_##_##EpilogueTag_##_##FUSION_##_##CTA_M_##_##CTA_N_##_##CTA_K_##_##CGA_M_##_##CGA_N_##_##CGA_K_##_##MXFPX_##_##BIAS_##_##SWAP_AB_(        \
    ...
    {                                                                                                                                                                                                                                                          \
        ...
        {                                                                                                                                                                                                                                                      \
            ...
            /* SM120 BlockScaled (FP8 x FP4) requires Stages >= 2   */                                                                                                                                                                                           \
            using StageCountType = std::conditional_t<IsSM120 && IsBlockScaled,                                                                                                                                                                                \
                cutlass::gemm::collective::StageCount<2>, StageCountAutoCarveout>;                                                                                                                                                                             \
                                                                                                                                                                                                                                                               \
            ...
            /* For SM120 grouped GEMM, use PtrArray schedules. BlockScaled (FP8/FP4) prefers pingpong. */                                                                                                                                                      \
            using KernelScheduleSM120 = std::conditional_t<IsBlockScaled,                                                                                                                                                                                      \
...
tma_ws_input.fpX_block_scaling_factors_stride_weight),                                                                                                                                                                         \
            ...
            {                                                                                                                                                                                                                                                  \
                ...
                {                                                                                                                                                                                                                                              \
                    ...
                    if constexpr (SwapAB)                                                                                                                                                                                                                      \
                    {                                                                                                                                                                                                                                          \
                        return construct_if_true<(FUSION == EpilogueFusion::FINALIZE && SwapAB), FusionArguments>(                                                                                                                                             \
    ...
    struct DispatchToTmaWSFunction<cutlass::arch::ArchTag_, DataType_, WeightType_, OutputType_,                                                                                                                                                               \
        ...
        cute::Shape<cute::Int<CGA_M_>, cute::Int<CGA_N_>, cute::Int<CGA_K_>>, MXFPX_, BIAS_, SWAP_AB_>                                                                                                                                                         \
    {                                                                                                                                                                                                                                                          \
