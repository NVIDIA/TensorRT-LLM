...
#define INSTANTIATE_TMA_WARP_SPECIALIZED_MOE_GEMM(ArchTag_, DataType_, WeightType_, OutputType_, EpilogueTag_,                                                                                                                         \
    ...
    {                                                                                                                                                                                                                                  \
        ...
        else if constexpr (!COMPILE_BLACKWELL_TMA_GROUPED_GEMMS_ENABLED && ArchTag::kMinComputeCapability >= 100 && ArchTag::kMinComputeCapability < 120)                                                                                                                      \
        {                                                                                                                                                                                                                              \
            TLLM_THROW(                                                                                                                                                                                                                \
                "Please recompile with support for blackwell by passing 100-real as an arch to build_wheel.py.");                                                                                                                      \
        }                                                                                                                                                                                                                              \
        else if constexpr (!COMPILE_BLACKWELL_SM120_TMA_GROUPED_GEMMS_ENABLED && ArchTag::kMinComputeCapability >= 120)                                                                                                                      \
        {                                                                                                                                                                                                                              \
            TLLM_THROW("Please recompile with support for blackwell by passing 120-real as an arch to build_wheel.py.");                                                                                                                   \
        }                                                                                                                                                                                                                              \
            ...
            {                                                                                                                                                                                                                          \
                ...
                {                                                                                                                                                                                                                      \
                    ...
                    return construct_if_true < FUSION == EpilogueFusion::NONE,                                                                                                                                                         \
                           EpilogueArguments > (epilogue_scalars, nullptr, tma_ws_input.stride_c,                                                                                                                                      \
                               reinterpret_cast<ElementD**>(epi_params.ptr_d), epi_params.stride_d);                                                                                                                                   \
                }                                                                                                                                                                                                                      \
                ...
                {                                                                                                                                                                                                                      \
                    ...
                    return construct_if_true < FUSION == EpilogueFusion::FINALIZE,                                                                                                                                                     \
                           EpilogueArguments > (epilogue_scalars, /* Parameters to underlying epilogue */                                                                                                                              \
