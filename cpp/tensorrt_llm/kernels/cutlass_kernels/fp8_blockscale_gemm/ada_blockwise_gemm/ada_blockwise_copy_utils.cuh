...
template <>
struct DefaultGemm_TensorOpSm80_OperandA<cute::float_e4m3_t,
...
template <>
struct DefaultGemm_TensorOpSm80_OperandA<cute::half_t,
                                         cutlass::layout::RowMajor, 8, 64>
{
    // Smem
...
template <>
struct DefaultGemm_TensorOpSm80_OperandA<cute::bfloat16_t,
                                         cutlass::layout::RowMajor, 8, 64>
{
    // Smem
    using SmemLayoutAtom = decltype(cute::composition(
        ...
        cute::Layout<cute::Shape<cute::_8, cute::_64>,
                     cute::Stride<cute::_64, cute::_1>>{}));
    using SmemCopyAtom =
        cute::Copy_Atom<cute::SM75_U32x4_LDSM_N, cute::bfloat16_t>;
...
template <int SizeK>
struct DefaultGemm_TensorOpSm80_OperandA<cute::half_t,
                                         cutlass::layout::ColumnMajor, 8, SizeK>
{
    // Smem
    using SmemLayoutAtom = decltype(cute::composition(
        cute::Swizzle<3, 3, 3>{},
                                         ...
                                         cutlass::layout::ColumnMajor, 8, SizeK>
{
    ...
    using SmemLayoutAtom = decltype(cute::composition(
        ...
        cute::Layout<cute::Shape<cute::_64, cute::_8>,
                     cute::Stride<cute::_1, cute::_64>>{}));
    using SmemCopyAtom =
        cute::Copy_Atom<cute::SM75_U16x8_LDSM_T, cute::bfloat16_t>;
...
struct DefaultGemm_TensorOpSm80_OperandB<
    cute::half_t, cutlass::layout::ColumnMajor, Alignment, SizeK>
    : DefaultGemm_TensorOpSm80_OperandA<cute::half_t, cutlass::layout::RowMajor,
                                        Alignment, SizeK>
{
};
...
template <int Alignment, int SizeK>
struct DefaultGemm_TensorOpSm80_OperandB<
    cute::bfloat16_t, cutlass::layout::ColumnMajor, Alignment, SizeK>
    : DefaultGemm_TensorOpSm80_OperandA<
          cute::bfloat16_t, cutlass::layout::RowMajor, Alignment, SizeK>
{
};
...
template <int Alignment, int SizeK>
struct DefaultGemm_TensorOpSm80_OperandB<
    cute::half_t, cutlass::layout::RowMajor, Alignment, SizeK>
    : DefaultGemm_TensorOpSm80_OperandA<
          cute::half_t, cutlass::layout::ColumnMajor, Alignment, SizeK>
{
};
...
template <int Alignment, int SizeK>
struct DefaultGemm_TensorOpSm80_OperandB<
    cute::float_e4m3_t, cutlass::layout::ColumnMajor, Alignment, SizeK>
    : DefaultGemm_TensorOpSm80_OperandA<
          cute::float_e4m3_t, cutlass::layout::RowMajor, Alignment, SizeK> {};
...
struct CopyTraitsScaleA {
    ...
    // Gmem
    using GmemLayoutTVScale = cute::Layout<
        cute::Shape<cute::Shape<cute::_32, cute::_4>, cute::Shape<cute::_1, cute::_1>>,
        cute::Stride<cute::Stride<cute::_1, cute::_0>, cute::Stride<cute::_1, cute::_1>>
    >;
    using GmemTileShapeScale = cute::Shape<cute::_32, cute::_1>;
    using GmemTiledCopyScale = decltype(cute::make_tiled_copy_impl( GmemCopyAtom{}, GmemLayoutTVScale{}, GmemTileShapeScale{}));

    // Smem
    using SmemCopyAtomScale = cute::Copy_Atom<cute::UniversalCopy<float>, float>;
    using SmemLayoutTVScale = cute::Layout<
    cute::Shape<cute::Shape<cute::_4, cute::_8, cute::_2, cute::_2>, cute::Shape<cute::_2>>,
    ...
    using SmemTiledCopyScale = decltype(cute::make_tiled_copy_impl( SmemCopyAtomScale{}, SmemLayoutTVScale{}, SmemTileShapeScale{}));
};
...
struct CopyTraitsScaleB {
    ...
    using SmemCopyAtomScale = cute::Copy_Atom<cute::UniversalCopy<float>, float>;
    using SmemLayoutTVScale = cute::Layout<
        cute::Shape<cute::Shape<cute::_4, cute::_8, cute::_2, cute::_2>, cute::Shape<cute::_1>>,
...
CUTE_DEVICE auto util_convert_type(cute::Tensor<Engine, Layout> const& tensor)
{
    ...
    auto frag =
        convert_op(*reinterpret_cast<cutlass::Array<From_type, numel> const*>(
            tensor.data()));
    return cute::make_tensor(cute::make_rmem_ptr<To_type>(&frag),
                             tensor.layout());
}

template <typename TiledCopy, typename Engine0, typename Layout0,
          typename Engine1, typename Layout1>
CUTE_DEVICE void util_copy(TiledCopy const& tiled_copy,
