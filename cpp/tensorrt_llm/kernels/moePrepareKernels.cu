        ...
        while (acquireNewStep)
        {
            if (threadIdx.x < UNIT_PER_ITER)
            {
                ...
                if (index < unitCount)
                {
                    ...
                    *((ExpertType*) (experts)) = *(ExpertType*) (sendExperts + tokenId * topK + groupId * PipelineConfig::UNIT_SIZE);
...
#pragma unroll
                    ...
                    *((ExpertType*) (expertsPtr)) = *((ExpertType*) (experts));
                    ...
                    {
                        *((ScaleType*) (scales)) = *(ScaleType*) (sendScales + tokenId * topK + groupId * PipelineConfig::UNIT_SIZE);
            ...
            if (threadIdx.x < UNIT_PER_ITER)
            {
                if (threadIdx.x < packetUnitCount)
                {
                    ...
                    *((ExpertType*) (experts)) = *((ExpertType*) (expertsPtr));
                    ExpertType* dstExpertsPtr = (ExpertType*) (recvExperts + tokenId * topK + groupId * PipelineConfig::UNIT_SIZE);
                    *dstExpertsPtr = *((ExpertType*) (experts));
                    ...
                    if (recvScales != nullptr)
                    {
                        ...
                        *((ScaleType*) (scales)) = *((ScaleType*) (scalesPtr));
                        ScaleType* dstScalesPtr = (ScaleType*) (recvScales + tokenId * topK + groupId * PipelineConfig::UNIT_SIZE);
