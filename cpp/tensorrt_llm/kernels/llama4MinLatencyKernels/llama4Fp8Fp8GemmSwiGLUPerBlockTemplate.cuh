...
#pragma unroll
                ...
                {
                    float4 a_val = fp8x4_to_float4(a_vec_current.data[i]);
                    float4 b_val_gate = fp8x4_to_float4(b_vec_current_gate.data[i]);
                    float4 b_val_linear = fp8x4_to_float4(b_vec_current_linear.data[i]);
