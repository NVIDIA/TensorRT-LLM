...
#pragma unroll
        ...
        {
            float4 a_val = fp8x4_to_float4(a_vec.data[i]);
            float4 b_val_linear = fp8x4_to_float4(b_vec_linear.data[i]);
            float4 b_val_gate = fp8x4_to_float4(b_vec_gate.data[i]);
...
#pragma unroll
        ...
        {
            float4 a_val = fp8x4_to_float4(a_vec.data[i]);
            float4 b_val = fp8x4_to_float4(b_vec[tile_row_idx].data[i]);
