...
void initBindings(nb::module_& m)
{
    ...
    nb::class_<GenLlmReq>(m, "GenericLlmRequest")
        ...
        .def("clear_context_phase_params", &GenLlmReq::clearContextPhaseParams)
        .def_prop_ro("kv_hint", &GenLlmReq::getKvHint)
    ...
    nb::class_<tb::LlmRequest, GenLlmReq>(m, "LlmRequest", nb::dynamic_attr())
        .def(
            ...
            [](tb::LlmRequest* self, tb::LlmRequest::RequestIdType request_id,
                ...
                std::optional<std::string> cache_salt, std::optional<executor::KvHint> kv_hint)
            {
                ...
                new (self) tb::LlmRequest{request_id, max_new_tokens, input_tokens, sampling_config, is_streaming,
                    ...
                    multimodal_run_lengths, std::move(cache_salt), std::move(kv_hint)};
            },
            ...
            nb::arg("cache_salt") = std::nullopt, nb::arg("kv_hint") = std::nullopt)
