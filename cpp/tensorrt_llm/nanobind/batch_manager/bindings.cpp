    ...
    nb::class_<tb::LlmRequest, GenLlmReq>(m, "LlmRequest", nb::dynamic_attr())
        .def(
            ...
            [](tb::LlmRequest* self, tb::LlmRequest::RequestIdType request_id,
                ...
                bool exclude_input_from_output, std::optional<tb::LlmRequest::VecTokens> encoder_input_tokens,
                ...
                std::optional<std::string> cache_salt)
            {
                ...
                new (self)
                    tb::LlmRequest{request_id, max_new_tokens, input_tokens, sampling_config, is_streaming, end_id,
                        pad_id, position_ids, prompt_embedding_table_tensor_ptr, prompt_vocab_size, multimodal_hashes,
                        ...
                        return_generation_logits, draft_tokens, draft_logits_tensor_ptr, exclude_input_from_output,
                        ...
                        llm_request_type, input_token_extra_ids, skip_cross_attn_blocks_tensor_ptr, return_perf_metrics,
