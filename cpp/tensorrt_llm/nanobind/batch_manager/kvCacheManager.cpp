...
void tb::kv_cache_manager::KVCacheManagerBindings::initBindings(nb::module_& m)
{
    ...
    nb::class_<tbk::KVCacheManager, tbk::BaseKVCacheManager>(m, "KVCacheManager")
        .def(nb::init<std::vector<SizeType32> const&, SizeType32, SizeType32,
                 std::map<SizeType32, std::tuple<SizeType32, SizeType32>> const&, SizeType32, std::string const&,
                 SizeType32, SizeType32, std::vector<SizeType32> const&, nvinfer1::DataType, SizeType32, int64_t,
                 SizeType32, SizeType32, bool, tbk::CacheType, std::optional<tensorrt_llm::executor::RetentionPriority>,
            ...
            nb::arg("max_num_sequences"), nb::arg("max_beam_width"), nb::arg("max_attention_window_vec"),
            nb::arg("dtype"), nb::arg("sink_token_length"), nb::arg("stream"), nb::arg("max_sequence_length"),
            nb::arg("chunk_size"), nb::arg("enable_block_reuse") = false, nb::arg("cache_type") = tbk::CacheType::kSELF,
            ...
            nb::arg("indexer_k_cache_use_fp4") = false, nb::arg("linear_attention_metadata").none() = std::nullopt,
            nb::arg("pool_configurations") = std::vector<tbk::PoolConfiguration>{},
            nb::call_guard<nb::gil_scoped_release>())
        .def(
