...
void tb::kv_cache_manager::KVCacheManagerBindings::initBindings(nb::module_& m)
{
    ...
    nb::class_<tbk::KvCacheStats>(m, "KvCacheStats")
        ...
        .def_rw("reused_blocks_gpu", &tbk::KvCacheStats::reusedBlocksGpu)
        .def_rw("reused_blocks_host", &tbk::KvCacheStats::reusedBlocksHost)
        .def_rw("reused_blocks_disk", &tbk::KvCacheStats::reusedBlocksDisk)
        .def_rw("reused_blocks_remote", &tbk::KvCacheStats::reusedBlocksRemote)
    ...
    nb::class_<tbk::KvCacheIterationStats>(m, "KvCacheIterationStats")
        ...
        .def_rw("iter_reused_blocks_gpu", &tbk::KvCacheIterationStats::iterReusedBlocksGpu)
        .def_rw("iter_reused_blocks_host", &tbk::KvCacheIterationStats::iterReusedBlocksHost)
        .def_rw("iter_reused_blocks_disk", &tbk::KvCacheIterationStats::iterReusedBlocksDisk)
        .def_rw("iter_reused_blocks_remote", &tbk::KvCacheIterationStats::iterReusedBlocksRemote)
...
void tb::BasePeftCacheManagerBindings::initBindings(nb::module_& m)
{
    ...
    nb::class_<tb::PeftCacheManager, tb::BasePeftCacheManager>(m, "PeftCacheManager")
        ...
        .def("is_task_cached_device", &tb::PeftCacheManager::isTaskCachedDevice, nb::arg("taskId"),
            nb::call_guard<nb::gil_scoped_release>()) // ;
        .def("configure_data_type", &tb::PeftCacheManager::configureDataType, nb::arg("data_type"),
            nb::call_guard<nb::gil_scoped_release>())
        .def_prop_ro("data_type", &tb::PeftCacheManager::getDataType)
