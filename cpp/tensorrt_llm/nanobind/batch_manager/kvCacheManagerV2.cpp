    ...
    nb::class_<kv::KVCacheManagerConfig>(m, "KVCacheManagerConfig")
        .def(
            ...
            [](kv::KVCacheManagerConfig* cfg, int tokensPerBlock, std::vector<kv::CacheTierConfig> cacheTiers,
                ...
                bool textOnly, bool fixedSsmPool)
            {
            ...
            nb::arg("enable_stats") = true, nb::arg("text_only") = false, nb::arg("fixed_ssm_pool") = false)
        ...
        .def_rw("fixed_ssm_pool", &kv::KVCacheManagerConfig::fixedSsmPool)
