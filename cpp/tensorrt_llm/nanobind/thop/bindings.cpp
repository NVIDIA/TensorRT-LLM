...
void initBindings(nb::module_& m)
{
    ...
    m.def("attention", &torch_ext::attention,
        ...
        nb::arg("sage_attn_qk_int8") = false, nb::arg("sage_attn_smooth_k") = false, nb::arg("num_contexts") = 0,
        nb::arg("num_ctx_tokens") = 0, nb::arg("trtllm_gen_jit_warmup") = false,
        nb::arg("aux_kv_cache_pool_ptr") = std::nullopt, nb::arg("is_cross") = false,
        ...
        nb::arg("quant_scale_qkv") = std::nullopt, nb::arg("dsv4_inv_rope_cos_sin_cache") = std::nullopt,
        nb::arg("enable_dsv4_epilogue_fusion") = false, nb::arg("force_prepare_spec_dec_tree_mask") = false,
        nb::arg("max_num_sequences") = std::nullopt, nb::arg("kv_norm_weight") = std::nullopt,
        nb::arg("kv_norm_eps") = 1e-6, nb::arg("skip_correction_threshold") = 0.0,
        nb::arg("uses_spcompress") = std::nullopt, "Multi-head attention operation",
