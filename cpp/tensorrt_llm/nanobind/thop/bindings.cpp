...
void initBindings(nb::module_& m)
{
    ...
    m.def("attention", &torch_ext::attention,
        ...
        nb::arg("force_prepare_spec_dec_tree_mask") = false, nb::arg("kv_norm_weight") = std::nullopt,
        nb::arg("kv_norm_eps") = 1e-6, "Multi-head attention operation", nb::call_guard<nb::gil_scoped_release>());
