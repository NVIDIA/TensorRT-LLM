...
void initBindings(nb::module_& m)
{
    ...
    m.def("attention", &torch_ext::attention,
        ...
        nb::arg("spec_decoding_tensor_params"), nb::arg("sparse_kv_indices"), nb::arg("sparse_kv_offsets"),
        nb::arg("sparse_attn_indices"), nb::arg("sparse_attn_offsets"), nb::arg("sparse_mla_topk"),
