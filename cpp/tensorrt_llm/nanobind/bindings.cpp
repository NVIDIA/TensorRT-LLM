...
NB_MODULE(TRTLLM_NB_MODULE, m)
{
    ...
    nb::enum_<tb::LlmRequestState>(m, "LlmRequestState")
        ...
        .value("CONTEXT_PREFETCH_INIT", tb::LlmRequestState::kCONTEXT_PREFETCH_INIT)
        .value("CONTEXT_PREFETCH_IN_PROGRESS", tb::LlmRequestState::kCONTEXT_PREFETCH_IN_PROGRESS)
        .value("CONTEXT_PREFETCH_COMPLETE", tb::LlmRequestState::kCONTEXT_PREFETCH_COMPLETE)
