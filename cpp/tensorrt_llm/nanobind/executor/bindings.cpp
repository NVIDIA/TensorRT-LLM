...
void initBindings(nb::module_& m)
{
    ...
    nb::class_<tle::IterationStats>(m, "IterationStats")
        ...
        .def_rw("scheduled_num_prefill_requests", &tle::IterationStats::scheduledNumPrefillRequests)
        .def_rw("scheduled_sum_prefill_tokens", &tle::IterationStats::scheduledSumPrefillTokens)
        .def_rw("scheduled_sum_prefill_kv_tokens", &tle::IterationStats::scheduledSumPrefillKvTokens)
        .def_rw("scheduled_num_decode_requests", &tle::IterationStats::scheduledNumDecodeRequests)
        .def_rw("scheduled_sum_decode_kv_tokens", &tle::IterationStats::scheduledSumDecodeKvTokens)
        .def_rw("queued_num_prefill_requests", &tle::IterationStats::queuedNumPrefillRequests)
        .def_rw("queued_sum_prefill_tokens", &tle::IterationStats::queuedSumPrefillTokens)
        .def_rw("queued_num_decode_requests", &tle::IterationStats::queuedNumDecodeRequests)
        .def_rw("queued_sum_decode_kv_tokens", &tle::IterationStats::queuedSumDecodeKvTokens)
        .def("to_json_str",
