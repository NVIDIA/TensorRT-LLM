...
void initConfigBindings(pybind11::module_& m)
{
    ...
    py::class_<tle::KvCacheConfig>(m, "KvCacheConfig")
        .def(py::init<bool, std::optional<SizeType32> const&, std::optional<std::vector<SizeType32>> const&,
                 ...
                 SizeType32, std::optional<RuntimeDefaults> const&, std::optional<uint64_t> const&>(),
            ...
            py::arg("attention_dp_events_gather_period_ms") = 5, py::arg("runtime_defaults") = py::none(), py::arg("max_free_gpu_memory_size") = py::none())
        .def_property(
