...
void initBindings(pybind11::module_& m)
{
    ...
    py::class_<tle::DecodingMode>(m, "DecodingMode")
        ...
        .def("is_auto", &tle::DecodingMode::isAuto)
        .def("is_top_k", &tle::DecodingMode::isTopK)
        .def("is_top_p", &tle::DecodingMode::isTopP)
        .def("is_top_kor_top_p", &tle::DecodingMode::isTopKorTopP)
        .def("is_top_kand_top_p", &tle::DecodingMode::isTopKandTopP)
        .def("is_beam_search", &tle::DecodingMode::isBeamSearch)
        .def("is_medusa", &tle::DecodingMode::isMedusa)
        .def("is_lookahead", &tle::DecodingMode::isLookahead)
        .def("is_explicit_draft_tokens", &tle::DecodingMode::isExplicitDraftTokens)
        .def("is_eagle", &tle::DecodingMode::isEagle)
        .def("get_name", &tle::DecodingMode::getName)
