...
void tensorrt_llm::pybind::batch_manager::algorithms::initBindings(pybind11::module_& m)
{
    ...
    py::class_<MicroBatchScheduler>(m, MicroBatchScheduler::name)
        .def(py::init<SizeType32, std::optional<SizeType32>, std::optional<batch_scheduler::ContextChunkingConfig>,
                 std::optional<SizeType32>, LlmRequestState, LlmRequestState>(),
            py::arg("max_batch_size"), py::arg("max_num_tokens") = std::nullopt,
