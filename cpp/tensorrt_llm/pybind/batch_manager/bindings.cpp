...
void initBindings(nanobind::module_& m)
{
    ...
    nb::class_<GenLlmReq>(m, "GenericLlmRequest")
        ...
        .def_prop_ro("is_full_context_request", &GenLlmReq::isFullContextRequest)
    ...
    nb::class_<tb::LlmRequest, GenLlmReq>(m, "LlmRequest", nanobind::dynamic_attr())
        .def(
            "__init__",
    ...
    nb::class_<tb::DraftBuffers>(m, "DraftBuffers")
        .def(nb::init<>())
        .def_rw("next_draft_tokens_device", &tb::DraftBuffers::nextDraftTokensDevice)
        .def_rw("next_draft_tokens_host", &tb::DraftBuffers::nextDraftTokensHost)
        .def_rw("prev_draft_tokens_lengths_device", &tb::DraftBuffers::prevDraftTokensLengthsDevice)
        .def_rw("prev_draft_tokens_lengths_host", &tb::DraftBuffers::prevDraftTokensLengthsHost)
        .def_rw("next_draft_tokens_lengths_device", &tb::DraftBuffers::nextDraftTokensLengthsDevice)
        .def_rw("next_draft_tokens_lengths_host", &tb::DraftBuffers::nextDraftTokensLengthsHost)
        .def_rw("accepted_lengths_cum_sum_device", &tb::DraftBuffers::acceptedLengthsCumSumDevice)
        .def_rw("accepted_packed_paths_device", &tb::DraftBuffers::acceptedPackedPathsDevice)
        .def_rw("predicted_draft_logits", &tb::DraftBuffers::predictedDraftLogits)
        .def("create", &tb::DraftBuffers::create, nb::arg("max_num_sequences"), nb::arg("max_tokens_per_step"),
            nb::arg("runtime"), nb::arg("model_config"));

    nb::class_<tb::DecoderBuffers>(m, "DecoderBuffers")
        .def(nb::init<runtime::SizeType32, runtime::SizeType32, runtime::BufferManager const&,
            ...
            nb::arg("max_num_sequences"), nb::arg("max_tokens_per_step"), nb::arg("buffer_manager"),
            nb::arg("model_config"), nb::arg("world_config"))
        .def_rw("draft_buffers", &tb::DecoderBuffers::draftBuffers);
