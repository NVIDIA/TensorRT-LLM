...
void initBindings(nanobind::module_& m)
{
    ...
    nb::class_<tr::decoder::DecoderState>(m, "DecoderState")
        .def(nb::init<nvinfer1::DataType, tr::BufferManager const&>(), nb::arg("dtype"), nb::arg("buffer_manager"))
        ...
        .def("allocate_speculative_decoding_buffers", &tr::decoder::DecoderState::allocateSpeculativeDecodingBuffers,
            nb::arg("speculative_decoding_mode"), nb::arg("dtype"), nb::arg("buffer_manager"))
        .def("setup_speculative_decoding", &tr::decoder::DecoderState::setupSpeculativeDecoding,
            nb::arg("speculative_decoding_mode"), nb::arg("max_tokens_per_engine_step"), nb::arg("model_config"),
            nb::arg("world_config"), nb::arg("buffer_manager"))
