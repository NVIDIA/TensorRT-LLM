...
void initBindings(pybind11::module_& m)
{
    ...
    m.def("attention", &torch_ext::attention,
        ...
        py::arg("sparse_attn_offsets") = std::nullopt, py::arg("sparse_attn_ctx_indices") = std::nullopt,
        py::arg("sparse_attn_indices_block_size"), py::arg("sparse_mla_topk") = std::nullopt,
