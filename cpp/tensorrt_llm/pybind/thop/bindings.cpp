...
void initBindings(pybind11::module_& m)
{
    ...
    m.def("attention", &torch_ext::attention,
        ...
        py::arg("spec_decoding_tensor_params"), py::arg("sparse_kv_indices"), py::arg("sparse_kv_offsets"),
        py::arg("sparse_attn_indices"), py::arg("sparse_attn_offsets"), py::arg("sparse_mla_topk"),
