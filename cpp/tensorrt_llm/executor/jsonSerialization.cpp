...
NLOHMANN_DEFINE_TYPE_NON_INTRUSIVE(IterationStats, timestamp, iter, iterLatencyMS, newActiveRequestsQueueLatencyMS,
    ...
    scheduledNumPrefillRequests, scheduledSumPrefillTokens, scheduledSumPrefillKvTokens, scheduledNumDecodeRequests,
    scheduledSumDecodeKvTokens, queuedNumPrefillRequests, queuedSumPrefillTokens, queuedNumDecodeRequests,
