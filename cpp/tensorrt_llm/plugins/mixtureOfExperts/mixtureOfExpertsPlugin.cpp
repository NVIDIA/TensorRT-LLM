    ...
    int scale_6_idx) const
{
    ...
    auto gated_inter_size = isGatedActivation(mActivationType) ? mExpertInterSize * 2 : mExpertInterSize;
    if (hasExpertIntQuantScales())
    {
        ...
        TLLM_CHECK(desc_1->dims.d[0] == mNumExperts);
        TLLM_CHECK(desc_1->dims.d[1] == gated_inter_size);
        TLLM_CHECK(desc_2->dims.d[0] == mNumExperts);
    ...
    else if (hasExpertFp8QuantScales())
    {
        ...
        TLLM_CHECK(desc_1->dims.d[0] == mNumExperts && desc_1->dims.d[1] == 1);
        TLLM_CHECK(desc_2->dims.d[0] == 1);
        TLLM_CHECK(desc_3->dims.d[0] == mNumExperts && desc_3->dims.d[1] == 1);
    ...
    else if (hasFP4QuantScales())
    {
        ...
        TLLM_CHECK(desc_2->dims.d[0] == mNumExperts && desc_2->dims.d[1] == gated_inter_size
            && desc_2->dims.d[2] == mExpertHiddenSize / TmaWarpSpecializedGroupedGemmInput::BlockScaleVectorSize);
        TLLM_CHECK(desc_3->dims.d[0] == mNumExperts);
        TLLM_CHECK(desc_4->dims.d[0] == 1);
        TLLM_CHECK(desc_5->dims.d[0] == mNumExperts && desc_5->dims.d[1] == mExpertHiddenSize
            && desc_5->dims.d[2] == mExpertInterSize / TmaWarpSpecializedGroupedGemmInput::BlockScaleVectorSize);
        TLLM_CHECK(desc_6->dims.d[0] == mNumExperts);
