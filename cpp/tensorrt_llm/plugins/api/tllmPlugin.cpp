...
#include "tensorrt_llm/plugins/fp8CurrentScalingGemmPlugin/fp8CurrentScalingGemmPlugin.h"
...
extern "C"
{
    ...
    [[maybe_unused]] nvinfer1::IPluginCreator* const* getPluginCreators(std::int32_t& nbCreators)
    {
        ...
        static tensorrt_llm::plugins::Fp8CurrentScalingGemmPluginCreator fp8CurrentScalingGemmPluginCreator;
        ...
        static std::array pluginCreators
            = { creatorPtr(identityPluginCreator),
                  ...
                  creatorPtr(fp8CurrentScalingGemmPluginCreator),
