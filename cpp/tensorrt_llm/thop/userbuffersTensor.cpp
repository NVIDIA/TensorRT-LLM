...
std::pair<torch::Tensor, tensorrt_llm::runtime::ub::UBBuffer> create_ub_tensor(
...
torch::Tensor create_userbuffers_tensor(at::IntArrayRef shape, torch::ScalarType dtype)
{
    return create_ub_tensor(shape, dtype).first;
}
...
{
    m.def("create_userbuffers_tensor", &torch_ext::create_userbuffers_tensor);
}
