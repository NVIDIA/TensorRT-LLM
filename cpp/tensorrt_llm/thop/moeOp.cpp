...
public:
        ...
        bool const enable_alltoall, bool min_latency_mode, torch::optional<c10::ArrayRef<int64_t>> const& profile_ids)
    {
        ...
        setWorkspaceInfo(num_rows, hidden_size, inter_size, num_experts_total, static_cast<int>(experts_per_token),
...
private:
    ...
    void setWorkspaceInfo(int64_t const num_rows, int64_t const hidden_size, int64_t const inter_size, int num_experts,
        int experts_per_token, ActivationType activation_type, kernels::MOEParallelismConfig const& parallelismConfig,
