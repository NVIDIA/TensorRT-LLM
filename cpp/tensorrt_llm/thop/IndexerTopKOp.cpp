    ...
    std::optional<th::Tensor> const& radix_aux_logits)
{
    ...
    {
        // fp32 path — Insertion / Radix / Radix-split-work dispatcher.
        // Caller-owned radix_aux_{indices,logits} are the
        ...
        {
            // Caller-owned scratch with stable address (CUDA Graph safe). The
