...
Tensor Hopper_mxfp4_dequantize(Tensor weight, Tensor scale, int64_t group_size)
{
    // weight (n, k / 2)
...
static auto Hopper_mxfp4_dequantize
    = torch::RegisterOperators("trtllm::Hopper_mxfp4_dequantize", &torch_ext::Hopper_mxfp4_dequantize);
