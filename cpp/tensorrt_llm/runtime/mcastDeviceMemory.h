...
private:
    ...
    //! Host collective used to exchange memory handles. Released by checkpointPrepare() while the
    //! communicator's runtime is still valid and re-installed by checkpointRestore().
