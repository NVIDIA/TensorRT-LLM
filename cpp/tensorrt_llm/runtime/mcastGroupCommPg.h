...
public:
    ...
    {
        return allreduceInt32(value, c10d::ReduceOp::MIN);
    }

    [[nodiscard]] int32_t allreduceMax(int32_t value) override
    {
        return allreduceInt32(value, c10d::ReduceOp::MAX);
    }
...
private:
    //! Reduces in place on the host, like the handle exchange.
    int32_t allreduceInt32(int32_t value, c10d::ReduceOp::RedOpType op)
    {
