...
//! \file tllmDataType.h
//!
//! Standalone, TensorRT-free runtime types that replace the \c nvinfer1
//! types the shared C++ core historically used as common currency:
//! \c tensorrt_llm::common::DataType and \c tensorrt_llm::common::Dims.
...
//! library. They are hoisted into the \c tensorrt_llm namespace with
//! using-declarations because they are common currency across the whole tree
//! (\c tensorrt_llm::DataType / \c tensorrt_llm::Dims).
//!
