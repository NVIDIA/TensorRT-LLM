...
public:
    ...
    explicit BlockManager(std::vector<SizeType32> const& numKvHeadsPerLayer, SizeType32 sizePerHead,
        SizeType32 tokensPerBlock,
        std::map<SizeType32, std::tuple<SizeType32, SizeType32>> const& numBlocksPerWindowSize,
...
public:
    ...
    [[nodiscard]] static SizeType32 calculateCacheSizePerToken(tensorrt_llm::runtime::ModelConfig const& modelConfig,
        tensorrt_llm::runtime::WorldConfig const& worldConfig, bool isCrossAttention, SizeType32 kvFactor = 2,
        std::vector<SizeType32> const& managedLayers)
    {
    ...
    [[nodiscard]] static std::map<SizeType32, std::tuple<SizeType32, SizeType32>> calculateMaxNumBlocks(
        ...
        runtime::BufferManager const& bufferManager, SizeType32 kvFactor = 2, size_t extraCostMemory = 0);
