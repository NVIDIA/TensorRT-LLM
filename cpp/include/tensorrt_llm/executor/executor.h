...
public:
    ...
    ContextPhaseParams(VecTokens firstGenTokens, RequestIdType reqId, std::optional<VecTokens> draftTokens,
        std::optional<std::string> cacheTransferServerEndpoint = std::nullopt);
    ...
    ContextPhaseParams(VecTokens firstGenTokens, RequestIdType reqId, std::vector<char> const& serializedState,
        std::optional<VecTokens> draftTokens, std::optional<std::string> cacheTransferServerEndpoint = std::nullopt);
    ...
    [[nodiscard]] std::optional<std::string> const& getCacheTransferServerEndpoint() const& noexcept;
...
private:
    ...
    /// @brief The endpoint of the cache transfer server
    std::optional<std::string> mCacheTransferServerEndpoint;
};
