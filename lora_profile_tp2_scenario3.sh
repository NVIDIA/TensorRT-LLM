...
echo "=== LoRA TRT gptManagerBenchmark TP=2 Scenario 3 Profiling ==="
echo "=============================================================="
...
# ============================================================================
# TP=2 Scenario 3: Engine WITH LoRA, Requests WITH LoRA
# ============================================================================
...
nsys profile \
    ...
    --output=${EG_DIR}/profiles/scenario3-lora-engine-lora-requests-tp-${TP}/gpt_manager_scenario3_tp2 \
...
echo "Profile saved to: ${EG_DIR}/profiles/scenario3-lora-engine-lora-requests-tp-${TP}/gpt_manager_scenario3_tp2.nsys-rep"
echo ""
echo "To view the profile, run:"
echo "nsys-ui ${EG_DIR}/profiles/scenario3-lora-engine-lora-requests-tp-${TP}/gpt_manager_scenario3_tp2.nsys-rep"
