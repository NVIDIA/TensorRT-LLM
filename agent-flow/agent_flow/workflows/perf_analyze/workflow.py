...
class PerfAnalyzeWorkflow:
    ...
    def _run_analyzer(self) -> None:
        ...
        self.analyzer(
            ...
            f"the replayed benchmark keeps `--no-test-input`. After that "
            ...
            f"the reason under *Caveats*) rather than fabricating it. Run ncu "
            f"last, "
            ...
            f"`server_nsys.nsys-rep`, the `nsys stats` output, "
