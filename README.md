> **DO NOT REVIEW — this branch is a one-off snapshot from main used only to trigger CI and produce a throwaway container for bench testing. No code review expected.**
