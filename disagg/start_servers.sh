cd /home/scratch.timothyg_gpu/TensorRT-LLM/disagg
...
# GEN_MODEL=/home/scratch.trt_llm_data/llm-models/llama-3.1-model/Llama-3.1-8B-Instruct-FP8
# GEN_MODEL=nvidia/Llama-3.1-8B-Instruct-FP8 
GEN_MODEL=nvidia/Llama-3.1-8B-Instruct-NVFP4
