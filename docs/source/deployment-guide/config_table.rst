...
.. list-table::
   ...
   * - 8xH200_SXM
     ...
     - 1024 / 8192
     - 512
     - `1k8k_tp8_conc512.yaml <https://github.com/NVIDIA/TensorRT-LLM/blob/main/examples/configs/database/deepseek-ai/DeepSeek-R1-0528/H200/1k8k_tp8_conc512.yaml>`_
     - ``trtllm-serve deepseek-ai/DeepSeek-R1-0528 --config ${TRTLLM_DIR}/examples/configs/database/deepseek-ai/DeepSeek-R1-0528/H200/1k8k_tp8_conc512.yaml``
   * - 8xH200_SXM
     - Min Latency
     - 8192 / 1024
     - 1
