...
- [KV Cache Compression](kv-cache-compression.md) — methods that change the
  stored KV representation or retained KV set while keeping cache management
  separate from sparse Attention configuration.
