...
flowchart TD
    ...
    subgraph Phase2["PHASE 2: RESOURCE SORTING"]
...
1. **Sorted** into `_paged_cache_order` during `initialize_resources()`
1. **Managed** by `KVCacheManager` if compatible with other KV handlers
