...
| `$dataset_file` | Location of the dataset file generated by `trtllm-bench prepare-dataset` |
...
In order to prepare a dataset, use the `trtllm-bench prepare-dataset` subcommand.
