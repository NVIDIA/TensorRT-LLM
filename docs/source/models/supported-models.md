...
| `DeepseekV4ForCausalLM` [^11]    | Yes               | Yes        | Yes                        | Untested              | Yes             | MTP                        | Yes           | Yes            | Yes                      | Yes                   | Untested        |
...
| `Qwen3NextForCausalLM` [^3]      | Yes               | Yes        | Yes                        | Untested              | Yes             | No                         | Yes           | Yes [^19]      | No                       | Yes                   | Untested        |
| `Qwen3_5MoeForCausalLM`          | Yes               | Yes        | Yes                        | Yes                   | Yes             | MTP                        | Yes           | Yes            | N/A                      | Yes                   | Untested        |
| `Qwen4ExpForCausalLM`            | Yes               | Yes        | Yes                        | No                    | Yes             | MTP                        | Yes           | Yes            | N/A                      | Untested [^20]        | Untested        |
...
| `Gemma4ForConditionalGeneration` | Yes [^24]          | Yes        | Yes [^24]                  | No                    | Yes             | MTP                        | Yes           | No             | Yes                      | Yes [^22]             | Untested        |
