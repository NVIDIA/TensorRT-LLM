...
| `DeepseekV4ForCausalLM` [^11]    | Yes               | Yes        | Yes                        | Untested              | Yes             | MTP                        | Yes           | Yes              | Yes            | Yes                      | Untested              | Untested        |
...
| `Qwen3NextForCausalLM` [^3]      | Yes               | Yes        | Yes                        | Untested              | Yes             | No                         | Yes           | Yes              | Yes [^19]      | No                       | Untested              | Untested        |
| `Qwen3_5MoeForCausalLM`          | Yes               | Yes        | Yes                        | Yes                   | Yes             | MTP                        | Yes           | Untested         | Yes            | N/A                      | Untested              | Untested        |
| `Qwen4ExpForCausalLM`            | Yes               | Yes        | Yes                        | No                    | Yes             | MTP                        | Yes           | Untested         | Untested       | N/A                      | Yes                   | Untested        |
...
| `Glm4MoeLiteForCausalLM` [^5]    | Yes               | Yes        | Untested                   | Untested              | Yes             | No                         | Yes           | Untested         | Yes            | N/A                      | Untested              | Untested        |
...
| `Step3p7ForConditionalGeneration`| Yes               | Yes        | Yes                        | Untested              | Untested        | MTP                        | Yes           | Untested         | No             | Yes                      | Untested              | Untested        |
