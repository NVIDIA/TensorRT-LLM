...
| `DeepseekV4ForCausalLM` [^11]    | Yes               | Yes        | Yes                        | Untested              | Yes             | MTP                        | Yes           | Yes              | Yes            | Yes                      | Yes                   | Untested        |
| `Glm4MoeForCausalLM`             | Yes               | Yes        | Yes                        | Untested              | Yes             | MTP                        | Yes           | Yes              | Yes            | N/A                      | Yes                   | Yes [^16]       |
| `Qwen3MoeForCausalLM`            | Yes               | Yes        | Yes                        | Yes                   | Yes             | EAGLE-3 (Linear, Dynamic)  | Yes           | Yes              | Yes            | N/A                      | Yes                   | Yes             |
| `Qwen3NextForCausalLM` [^3]      | Yes               | Yes        | Yes                        | Untested              | Yes             | No                         | Yes           | Yes              | Yes [^19]      | No                       | Yes                   | Untested        |
| `Qwen3_5MoeForCausalLM`          | Yes               | Yes        | Yes                        | Yes                   | Yes             | MTP                        | Yes           | Untested         | Yes            | N/A                      | Yes                   | Untested        |
| `Qwen4ExpForCausalLM`            | Yes               | Yes        | Yes                        | No                    | Yes             | MTP                        | Yes           | Untested         | Yes            | N/A                      | Untested [^20]        | Untested        |
| `Llama4ForConditionalGeneration` | Yes               | Yes        | Yes                        | Yes                   | Yes             | EAGLE-3 (Linear, Dynamic)  | Yes           | Yes              | Yes            | N/A                      | Yes                   | Yes             |
...
| `Glm4MoeLiteForCausalLM` [^5]    | Yes               | Yes        | Untested                   | Untested              | Yes             | No                         | Yes           | Untested         | Yes            | N/A                      | No [^21]              | Untested        |
| `NemotronHForCausalLM`           | Yes               | Yes        | Yes                        | Yes                   | Yes             | MTP                        | Yes           | Yes              | Yes            | N/A                      | Yes                   | Untested        |
| `Gemma4ForConditionalGeneration` | Untested          | Yes        | Untested                   | No                    | Yes             | MTP                        | Yes           | Untested         | No             | Yes                      | Untested [^22]        | Untested        |
| `Gemma4UnifiedForConditionalGeneration` | Untested          | Untested   | Untested                   | No                    | Yes             | No                         | Yes           | Untested         | No             | Yes                      | Yes [^23]             | Untested        |
| `Step3p7ForConditionalGeneration`| Yes               | Yes        | Yes                        | Untested              | Untested        | MTP                        | Yes           | Untested         | No             | Yes                      | Yes                   | Untested        |
| `MiniMaxM3SparseForConditionalGeneration` [^12] | Yes               | Yes        | Yes                        | Untested              | Untested        | No                         | Yes           | Untested         | No             | N/A                      | Yes                   | Untested        |
