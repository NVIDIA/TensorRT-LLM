...
| `InklingForConditionalGeneration` [^15] | Yes       | Yes        | Yes                        | No                    | Yes             | No  | No               | No                | No     | Yes           | Untested         | Yes            | Yes                      | Yes                   | No              |
...
| `InklingForConditionalGeneration`    | Yes               | Yes        | Yes             | Yes           | Untested         | No             | Yes                   | No                        | L + I + V + A [^15] |
