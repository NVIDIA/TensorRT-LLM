...
| `Qwen4ExpForCausalLM`            | Yes               | Yes        | Yes                        | No                    | Yes             | MTP                        | Yes           | Yes            | N/A                      | Untested [^20]        | Yes             |
...
| `Glm4MoeLiteForCausalLM` [^5]    | Yes               | Yes        | Untested                   | Untested              | Yes             | No                         | Yes           | Yes            | N/A                      | No [^21]              | Yes             |
| `NemotronHForCausalLM`           | Yes               | Yes        | Yes                        | Yes                   | Yes             | MTP                        | Yes           | Yes            | N/A                      | Yes                   | Yes             |
| `Gemma4ForConditionalGeneration` | Yes [^24]          | Yes        | Yes [^24]                  | No                    | Yes             | MTP                        | Yes           | No             | Yes                      | Yes [^22]             | Yes             |
| `Gemma4UnifiedForConditionalGeneration` | Yes [^24]          | Yes [^24] | Yes [^24]                  | No                    | Yes             | No                         | Yes           | No             | Yes                      | Yes [^23]             | Yes             |
