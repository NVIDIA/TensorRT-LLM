...
| `GlmMoeDsaForCausalLM` [^7]                | GLM-5                                                     | `zai-org/GLM-5`                                |
...
| `LlamaForCausalLM`                          | Llama 3.1, Llama 3, Llama 2, CodeLlama, SmolLM 3, Granite 3.x, Skywork | `meta-llama/Meta-Llama-3.1-70B` |
...
| `Phi3ForCausalLM`                            | Phi-4, Phi-4 Reasoning                                    | `microsoft/Phi-4`                              |
| `Phi4FlashForCausalLM` [^7]                | Phi-4 Flash (hybrid Mamba)                                 | `microsoft/Phi-4-mini-flash-reasoning`         |
...
| `SeedOssForCausalLM` [^7]                  | Seed-OSS                                                   | `ByteDance-Seed/Seed-OSS-36B-Instruct`         |
...
| `GlmMoeDsaForCausalLM` [^7]             | Yes               | Yes        | Untested                   | Untested              | Yes             | No  | No                        | No                        | Yes           | Untested         | Untested       | N/A                      | Untested              | Untested        |
...
| `Phi4FlashForCausalLM` [^7]             | Yes               | Yes        | Untested                   | Untested              | Yes             | No  | No                        | No                        | Yes           | Untested         | Untested       | N/A                      | Untested              | Untested        |
| `SeedOssForCausalLM` [^7]               | Yes               | Yes        | Untested                   | Untested              | Yes             | No  | No                        | No                        | Yes           | Untested         | Untested       | N/A                      | Untested              | Untested        |
