...
| **LTX-2 Retake** [^8] | No | No | No | No | No | No | No | No | Yes | Yes | No | No | No | No |
...
[^8]: LTX-2 Retake currently supports BF16 inference on one GPU. Quantized execution, cache acceleration, CUDA Graph, parallel VAE, and distributed parallelism are not enabled yet.
