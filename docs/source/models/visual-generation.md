...
| **Qwen-Image** [^5] | Yes | Yes | Yes | Yes [^6] | No | Yes | No | Yes | Yes | Yes | Yes | Yes | No | No |
...
[^6]: If Cache-DiT output quality is poor with Qwen-Image, lower `residual_diff_threshold` from the default `0.24` to `0.1`–`0.2`.
