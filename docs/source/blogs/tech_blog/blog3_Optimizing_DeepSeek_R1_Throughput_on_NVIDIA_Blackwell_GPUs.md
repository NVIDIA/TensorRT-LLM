...
The checkpoint used in this blog is hosted in [nvidia/DeepSeek-R1-FP4](https://huggingface.co/nvidia/DeepSeek-R1-FP4), generated by [NVIDIA Model Optimizer](https://github.com/NVIDIA/TensorRT-Model-Optimizer). The MoE layers inside this checkpoint have been quantized into FP4. Quantizing the MoE layer weights into FP4 has the following benefits:
...
![](../media/tech_blog3_mla_absorb.png)
Figure \- Weights Absorbed MLA
...
* FP8 KV Cache
    ...
    |  | FP8 Checkpoint | FP4 Checkpoint |
    | :---- | :---- | :---- |
    | BF16 MLA and KV cache | 0.9629 | 0.9606 |
    | FP8 MLA and KV cache | 0.9613 | 0.9606 |

    Table \- accuracy evaluation of FP8 KV cache
