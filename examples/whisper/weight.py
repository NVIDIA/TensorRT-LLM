    ...
    if component == "decoder":
        ...
        for i in range(tllm_model.num_layers):
            ...
            layer.self_attention.qkv.weight.value = fuse_qkv(
                pytorch_model[f'{layer_prefix}layer.0.SelfAttention.q_proj.weight'],
                pytorch_model[f'{layer_prefix}layer.0.SelfAttention.k_proj.weight'],
                pytorch_model[f'{layer_prefix}layer.0.SelfAttention.v_proj.weight'])
            ...
            if tllm_model.has_attention_qkvo_bias:
                layer.self_attention.qkv.bias.value = fuse_qkv(
                    pytorch_model[
                        f'{layer_prefix}layer.0.SelfAttention.q_proj.bias'],
                    pytorch_model[
                        f'{layer_prefix}layer.0.SelfAttention.k_proj.bias'],
                    pytorch_model[f'{layer_prefix}layer.0.SelfAttention.v_proj.bias']
                )
            ...
            layer.cross_attention.qkv.weight.value = fuse_qkv(
                pytorch_model[
                    f'{layer_prefix}layer.1.EncDecAttention.q_proj.weight'],
                pytorch_model[
                    f'{layer_prefix}layer.1.EncDecAttention.k_proj.weight'],
                pytorch_model[f'{layer_prefix}layer.1.EncDecAttention.v_proj.weight']
            )
            ...
            if tllm_model.has_attention_qkvo_bias:
                layer.cross_attention.qkv.bias.value = fuse_qkv(
                    pytorch_model[
                        f'{layer_prefix}layer.1.EncDecAttention.q_proj.bias'],
                    pytorch_model[
                        f'{layer_prefix}layer.1.EncDecAttention.k_proj.bias'],
                    pytorch_model[
                        f'{layer_prefix}layer.1.EncDecAttention.v_proj.bias'])
