...
python models/qwen_image_edit.py --visual_gen_args configs/qwen-image-edit-2511-bf16-1gpu.yaml --image /path/to/source.png --prompt "Make the image look like a watercolor painting"
