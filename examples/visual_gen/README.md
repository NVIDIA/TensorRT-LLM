...
python models/qwen_image_edit.py --image /path/to/source.png
...
python models/qwen_image_edit.py --visual_gen_args configs/qwen-image-edit-2511-bf16-1gpu.yaml --image /path/to/source.png
python models/qwen_image_edit.py --visual_gen_args configs/qwen-image-edit-2511-fp4-1gpu.yaml --image /path/to/source.png
```
