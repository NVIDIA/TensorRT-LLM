...
Qwen-Image-Bench/Q-Judger model through TensorRT-LLM to evaluate an image
generated by another image or vision-language model. Provide the original
generation prompt and the generated image path:

```bash
python examples/visual_gen/qwen_image_bench_eval.py \
