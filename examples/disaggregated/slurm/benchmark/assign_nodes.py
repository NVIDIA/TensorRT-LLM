...
def main():
    ...
    parser.add_argument(
        "--num-gen-servers", type=int, required=True, help="Number of generation servers"
    )
    parser.add_argument(
        "--num-ctx-servers", type=int, required=True, help="Number of context servers"
    )
    parser.add_argument(
        "--gen-world-size", type=int, required=True, help="World size for generation servers"
    )
    parser.add_argument(
        "--ctx-world-size", type=int, required=True, help="World size for context servers"
    )
