...
CONCURRENCY_1_COMBINATIONS=(
    ...
    # # 64 GPU
    # "64,1,252928,8192,1,1,64,64,0"  # tep_64: TP=1, CP=64
    # "64,1,252928,8192,1,2,32,64,0"  # tep_64: TP=2, CP=32
    # "64,1,252928,8192,1,4,16,64,0"  # tep_64: TP=4, CP=16
    # "64,1,252928,8192,1,8,8,64,0"   # tep_64: TP=8, CP=8
    # "64,1,252928,8192,1,16,4,64,0"  # tep_64: TP=16, CP=4
    # "64,1,252928,8192,1,32,2,64,0"  # tep_64: TP=32, CP=2
    # "64,1,252928,8192,1,64,1,64,0"  # tep_64: TP=64, CP=1
)
...
GEN8_COMBINATIONS=(
    ...
    "8,64,252928,8192,1,1,8,8,0"
    "8,128,252928,8192,1,1,8,8,0"
    # tep_8: TP=2, CP=4
...
GEN16_COMBINATIONS=(
    ...
    "16,64,252928,8192,1,1,16,16,0"
    "16,128,252928,8192,1,1,16,16,0"
    "16,256,252928,8192,1,1,16,16,0"
    # tep_16: TP=2, CP=8
    ...
    "16,64,252928,8192,1,2,8,16,0"
    "16,128,252928,8192,1,2,8,16,0"
    # tep_16: TP=4, CP=4
...
GEN32_COMBINATIONS=(
    ...
    "32,64,252928,8192,1,1,32,32,0"
    "32,128,252928,8192,1,1,32,32,0"
    "32,256,252928,8192,1,1,32,32,0"
    "32,512,252928,8192,1,1,32,32,0"
    # tep_32: TP=2, CP=16
    ...
    "32,64,252928,8192,1,2,16,32,0"
    "32,128,252928,8192,1,2,16,32,0"
    "32,256,252928,8192,1,2,16,32,0"
    # tep_32: TP=4, CP=8
    ...
    "32,64,252928,8192,1,4,8,32,0"
    "32,128,252928,8192,1,4,8,32,0"
    # tep_32: TP=8, CP=4
...
# =============================================================================
# 64 GPU COMBINATIONS - TP x CP = 64
# NOTE: max_scheduled estimates are for Kimi K2 NVFP4 at ISL=252928 on GB300.
#       K2 has 384 experts (vs DSV3 256) + ~2x ISL → roughly half the DSR1 limits.
# =============================================================================
GEN64_COMBINATIONS=(
    # tep_64: TP=1, CP=64
    "64,2,252928,8192,1,1,64,64,0"
    "64,4,252928,8192,1,1,64,64,0"
    "64,8,252928,8192,1,1,64,64,0"
    "64,16,252928,8192,1,1,64,64,0"
    "64,32,252928,8192,1,1,64,64,0"
    "64,64,252928,8192,1,1,64,64,0"
    "64,128,252928,8192,1,1,64,64,0"
    "64,256,252928,8192,1,1,64,64,0"
    "64,512,252928,8192,1,1,64,64,0"
    "64,1024,252928,8192,1,1,64,64,0"
    "64,2048,252928,8192,1,1,64,64,0"
    # tep_64: TP=2, CP=32
    "64,2,252928,8192,1,2,32,64,0"
    "64,4,252928,8192,1,2,32,64,0"
    "64,8,252928,8192,1,2,32,64,0"
    "64,16,252928,8192,1,2,32,64,0"
    "64,32,252928,8192,1,2,32,64,0"
    "64,64,252928,8192,1,2,32,64,0"
    "64,128,252928,8192,1,2,32,64,0"
    "64,256,252928,8192,1,2,32,64,0"
    "64,512,252928,8192,1,2,32,64,0"
    "64,1024,252928,8192,1,2,32,64,0"
    # tep_64: TP=4, CP=16
    "64,2,252928,8192,1,4,16,64,0"
    "64,4,252928,8192,1,4,16,64,0"
    "64,8,252928,8192,1,4,16,64,0"
    "64,16,252928,8192,1,4,16,64,0"
    "64,32,252928,8192,1,4,16,64,0"
    "64,64,252928,8192,1,4,16,64,0"
    "64,128,252928,8192,1,4,16,64,0"
    "64,256,252928,8192,1,4,16,64,0"
    "64,512,252928,8192,1,4,16,64,0"
    # tep_64: TP=8, CP=8
    "64,2,252928,8192,1,8,8,64,0"
    "64,4,252928,8192,1,8,8,64,0"
    "64,8,252928,8192,1,8,8,64,0"
    "64,16,252928,8192,1,8,8,64,0"
    "64,32,252928,8192,1,8,8,64,0"
    "64,64,252928,8192,1,8,8,64,0"
    "64,128,252928,8192,1,8,8,64,0"
    "64,256,252928,8192,1,8,8,64,0"
    # tep_64: TP=16, CP=4
    "64,2,252928,8192,1,16,4,64,0"
    "64,4,252928,8192,1,16,4,64,0"
    "64,8,252928,8192,1,16,4,64,0"
    "64,16,252928,8192,1,16,4,64,0"
    "64,32,252928,8192,1,16,4,64,0"
    "64,64,252928,8192,1,16,4,64,0"
    "64,128,252928,8192,1,16,4,64,0"
    # tep_64: TP=32, CP=2
    "64,2,252928,8192,1,32,2,64,0"
    "64,4,252928,8192,1,32,2,64,0"
    "64,8,252928,8192,1,32,2,64,0"
    "64,16,252928,8192,1,32,2,64,0"
    "64,32,252928,8192,1,32,2,64,0"
    "64,64,252928,8192,1,32,2,64,0"
    # tep_64: TP=64, CP=1 (est. max_scheduled~28)
    "64,2,252928,8192,1,64,1,64,0"
    "64,4,252928,8192,1,64,1,64,0"
    "64,8,252928,8192,1,64,1,64,0"
    "64,16,252928,8192,1,64,1,64,0"
)
...
INFEASIBLE_COMBINATIONS=(
    ...
    # 64 GPU, TP=64, CP=1: est. max_scheduled~28
    "64,32,252928,8192,1,64,1,64,0" # est. max_scheduled~28 < batch=32
)
...
usage() {
    echo "Usage: $0 [gen4|gen8|gen16|gen32|gen64|all|concurrency1|infeasible]"
    echo ""
    ...
    echo "Constraints: 4 <= num_gpus <= 64, PP=1, concurrency 2-32 (1 separate)"
    ...
    echo "  gen64        Run 64 GPU combinations (concurrency >= 2)"
...
case "$MODE" in
    ...
    gen64)
        ...
        MODE_DESC="64 GPU TP/CP"
        ;;
    all)
        COMBINATIONS=("${CONCURRENCY_1_COMBINATIONS[@]}" "${GEN4_COMBINATIONS[@]}" "${GEN8_COMBINATIONS[@]}" "${GEN16_COMBINATIONS[@]}" "${GEN32_COMBINATIONS[@]}" "${GEN64_COMBINATIONS[@]}")
