...
# Low Latency Benchmark script for TP x CP sweep in gen-only mode
...
CONFIGS_DIR="${WORK_DIR}/saved_configs/${TIMESTAMP}_tp_cp_low_latency"
...
CONCURRENCY_1_COMBINATIONS=(
    # 2 GPU
    "2,1,131072,8192,1,1,2,2,0"   # tep_2: TP=1, CP=2
    "2,1,131072,8192,1,2,1,2,0"   # tep_2: TP=2, CP=1
    # 4 GPU
    "4,1,131072,8192,1,1,4,4,0"   # tep_4: TP=1, CP=4
    "4,1,131072,8192,1,2,2,4,0"   # tep_4: TP=2, CP=2
    "4,1,131072,8192,1,4,1,4,0"   # tep_4: TP=4, CP=1
    # 8 GPU
    "8,1,131072,8192,1,1,8,8,0"   # tep_8: TP=1, CP=8
    "8,1,131072,8192,1,2,4,8,0"   # tep_8: TP=2, CP=4
    "8,1,131072,8192,1,4,2,8,0"   # tep_8: TP=4, CP=2
    "8,1,131072,8192,1,8,1,8,0"   # tep_8: TP=8, CP=1
    # 16 GPU
    "16,1,131072,8192,1,1,16,16,0"  # tep_16: TP=1, CP=16
    "16,1,131072,8192,1,2,8,16,0"   # tep_16: TP=2, CP=8
    "16,1,131072,8192,1,4,4,16,0"   # tep_16: TP=4, CP=4
    "16,1,131072,8192,1,8,2,16,0"   # tep_16: TP=8, CP=2
    "16,1,131072,8192,1,16,1,16,0"  # tep_16: TP=16, CP=1
)

# =============================================================================
# 2 GPU COMBINATIONS - TP x CP = 2
# =============================================================================
GEN2_COMBINATIONS=(
    # tep_2: TP=1, CP=2 (max_scheduled=28)
    "2,2,131072,8192,1,1,2,2,0"
    "2,4,131072,8192,1,1,2,2,0"
    "2,8,131072,8192,1,1,2,2,0"
    "2,16,131072,8192,1,1,2,2,0"
    # tep_2: TP=2, CP=1 (max_scheduled=15)
    "2,2,131072,8192,1,2,1,2,0"
    "2,4,131072,8192,1,2,1,2,0"
    "2,8,131072,8192,1,2,1,2,0"
)
...
GEN4_COMBINATIONS=(
    ...
    "4,8,131072,8192,1,1,4,4,0"
    "4,16,131072,8192,1,1,4,4,0"
    "4,32,131072,8192,1,1,4,4,0"
    "4,64,131072,8192,1,1,4,4,0"
    # tep_4: TP=2, CP=2 (max_scheduled=58)
    "4,2,131072,8192,1,2,2,4,0"
    "4,4,131072,8192,1,2,2,4,0"
    "4,8,131072,8192,1,2,2,4,0"
    "4,16,131072,8192,1,2,2,4,0"
    "4,32,131072,8192,1,2,2,4,0"
    # tep_4: TP=4, CP=1 (max_scheduled=31)
    "4,2,131072,8192,1,4,1,4,0"
    "4,4,131072,8192,1,4,1,4,0"
    "4,8,131072,8192,1,4,1,4,0"
    "4,16,131072,8192,1,4,1,4,0"
)
...
GEN8_COMBINATIONS=(
    ...
    "8,16,131072,8192,1,1,8,8,0"
    "8,32,131072,8192,1,1,8,8,0"
    "8,64,131072,8192,1,1,8,8,0"
    # tep_8: TP=2, CP=4
    "8,2,131072,8192,1,2,4,8,0"
    "8,4,131072,8192,1,2,4,8,0"
    "8,8,131072,8192,1,2,4,8,0"
    "8,16,131072,8192,1,2,4,8,0"
    "8,32,131072,8192,1,2,4,8,0"
    "8,64,131072,8192,1,2,4,8,0"
    # tep_8: TP=4, CP=2
    "8,2,131072,8192,1,4,2,8,0"
    "8,4,131072,8192,1,4,2,8,0"
    "8,8,131072,8192,1,4,2,8,0"
    "8,16,131072,8192,1,4,2,8,0"
    "8,32,131072,8192,1,4,2,8,0"
    "8,64,131072,8192,1,4,2,8,0"
    # tep_8: TP=8, CP=1 (max_scheduled=38)
    "8,2,131072,8192,1,8,1,8,0"
    "8,4,131072,8192,1,8,1,8,0"
    "8,8,131072,8192,1,8,1,8,0"
    "8,16,131072,8192,1,8,1,8,0"
    "8,32,131072,8192,1,8,1,8,0"
)
...
GEN16_COMBINATIONS=(
    # tep_16: TP=1, CP=16
    "16,2,131072,8192,1,1,16,16,0"
    "16,4,131072,8192,1,1,16,16,0"
    "16,8,131072,8192,1,1,16,16,0"
    "16,16,131072,8192,1,1,16,16,0"
    "16,32,131072,8192,1,1,16,16,0"
    "16,64,131072,8192,1,1,16,16,0"
    # tep_16: TP=2, CP=8
    "16,2,131072,8192,1,2,8,16,0"
    "16,4,131072,8192,1,2,8,16,0"
    "16,8,131072,8192,1,2,8,16,0"
    "16,16,131072,8192,1,2,8,16,0"
    "16,32,131072,8192,1,2,8,16,0"
    "16,64,131072,8192,1,2,8,16,0"
    # tep_16: TP=4, CP=4
    "16,2,131072,8192,1,4,4,16,0"
    "16,4,131072,8192,1,4,4,16,0"
    "16,8,131072,8192,1,4,4,16,0"
    "16,16,131072,8192,1,4,4,16,0"
    "16,32,131072,8192,1,4,4,16,0"
    "16,64,131072,8192,1,4,4,16,0"
    # tep_16: TP=8, CP=2
    "16,2,131072,8192,1,8,2,16,0"
    "16,4,131072,8192,1,8,2,16,0"
    "16,8,131072,8192,1,8,2,16,0"
    "16,16,131072,8192,1,8,2,16,0"
    "16,32,131072,8192,1,8,2,16,0"
    "16,64,131072,8192,1,8,2,16,0"
    # tep_16: TP=16, CP=1 (max_scheduled=42)
    "16,2,131072,8192,1,16,1,16,0"
    "16,4,131072,8192,1,16,1,16,0"
    "16,8,131072,8192,1,16,1,16,0"
    "16,16,131072,8192,1,16,1,16,0"
    "16,32,131072,8192,1,16,1,16,0"
)

# =============================================================================
# INFEASIBLE COMBINATIONS - Excluded from 'all' mode
# These configs cannot achieve saturated batch size due to parallelism limits.
# =============================================================================
INFEASIBLE_COMBINATIONS=(
    # 2 GPU, TP=1, CP=2: max_scheduled=28
    "2,32,131072,8192,1,1,2,2,0"   # max_scheduled=28 < batch=32
    "2,64,131072,8192,1,1,2,2,0"   # max_scheduled=28 < batch=64
    # 2 GPU, TP=2, CP=1: max_scheduled=15
    "2,16,131072,8192,1,2,1,2,0"   # max_scheduled=15 < batch=16
    "2,32,131072,8192,1,2,1,2,0"   # max_scheduled=15 < batch=32
    "2,64,131072,8192,1,2,1,2,0"   # max_scheduled=15 < batch=64
    # 4 GPU, TP=2, CP=2: max_scheduled=58
    "4,64,131072,8192,1,2,2,4,0"   # max_scheduled=58 < batch=64
    # 4 GPU, TP=4, CP=1: max_scheduled=31
    "4,32,131072,8192,1,4,1,4,0"   # max_scheduled=31 < batch=32
    "4,64,131072,8192,1,4,1,4,0"   # max_scheduled=31 < batch=64
    # 8 GPU, TP=8, CP=1: max_scheduled=38
    "8,64,131072,8192,1,8,1,8,0"   # max_scheduled=38 < batch=64
    # 16 GPU, TP=16, CP=1: max_scheduled=42
    "16,64,131072,8192,1,16,1,16,0" # max_scheduled=42 < batch=64
)
...
usage() {
    echo "Usage: $0 [gen2|gen4|gen8|gen16|all|concurrency1|infeasible]"
    echo ""
    echo "Low Latency TP x CP sweep for gen-only mode (TEP only, no AttnDP)"
    echo "Constraints: 2 <= num_gpus <= 16, PP=1, concurrency 2-64 (1 separate)"
    echo ""
    echo "Options:"
    echo "  gen2         Run 2 GPU combinations (concurrency >= 2)"
...
echo "Constraints: 2 <= num_gpus <= 16, PP=1, TEP only"
