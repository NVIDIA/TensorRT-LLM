...
def parse_arguments():
    ...
    parser.add_argument('--engine_dir', type=str, default='yi_outputs')
...
def generate(
    max_output_len: int,
    log_level: str = 'error',
    engine_dir: str = 'yi_outputs',
    input_text: str = '0,1,2,3,4,5,',
    input_file: str = None,
    output_csv: str = None,
    output_npy: str = None,
    ...
    engine_name = get_engine_name('yi', dtype, tp_size, pp_size, runtime_rank)
