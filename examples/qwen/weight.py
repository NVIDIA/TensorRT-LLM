...
def load_from_gptq_qwen(
    ...
    for layer in tqdm(layers_range, ncols=80, desc="loading attention weight..."):
        ...
        tensorrt_llm_qwen.layers[idx].attention.qkv.zero.value = th_zero.to(torch_dtype).numpy() 
    ...
    for k, v in tqdm(model_params.items(), ncols=80, desc="loading other weight..."):
        ...
        if "transformer.wte.weight" in k:
            ...
            if "ln_1.weight" in k:
                ...
                tensorrt_llm_qwen.layers[idx].attention.dense.zero.value = th_zero.to(torch_dtype).numpy()
                ...
                tensorrt_llm_qwen.layers[idx].mlp.gate.qweight.value = th_qweight.numpy()
                tensorrt_llm_qwen.layers[idx].mlp.gate.zero.value = th_zero.to(torch_dtype).numpy()
                tensorrt_llm_qwen.layers[idx].mlp.gate.scale.value = th_scale.to(torch_dtype).numpy()
                ...
                tensorrt_llm_qwen.layers[idx].mlp.proj.qweight.value = th_qweight.numpy()
                tensorrt_llm_qwen.layers[idx].mlp.proj.zero.value = th_zero.to(torch_dtype).numpy()
                tensorrt_llm_qwen.layers[idx].mlp.proj.scale.value = th_scale.to(torch_dtype).numpy()
                ...
                tensorrt_llm_qwen.layers[idx].mlp.fc.qweight.value = th_qweight.numpy()
                tensorrt_llm_qwen.layers[idx].mlp.fc.zero.value = th_zero.to(torch_dtype).numpy()
                tensorrt_llm_qwen.layers[idx].mlp.fc.scale.value = th_scale.to(torch_dtype).numpy()
