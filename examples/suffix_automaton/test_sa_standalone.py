...
def test_basic_pattern_matching():
    ...
    print("Pattern: 'AB' at end should match 'AB' at beginning")
...
def test_long_pattern():
    ...
    print("Looking for suffix match...")
...
def test_module_interface():
    ...
    accepted_tokens = torch.tensor(
        [[3, 4, 0, 0, 0], [10, 0, 0, 0, 0]], dtype=torch.int32, device="cuda"
    )
    ...
    print("Extended with accepted tokens")
