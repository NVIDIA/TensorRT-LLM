...
- confidence-vs-acceptance calibration table, for calibrating the DSpark
  ...
  collected when the confidence provider is in the tree (DSpark
  confidence MR !75 + its provider hookup MR) and the drafter ships a
        ...
        if args.confidence_threshold is not None:
            ...
            if "confidence_threshold" not in DFlashDecodingConfig.model_fields:
                raise SystemExit(
                    ...
                    "confidence-scheduled verification MR in the tree "
