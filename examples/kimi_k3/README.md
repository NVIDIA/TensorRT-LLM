...
- **Known performance regression at DEP16 saturation** (attention-DP +
  ...
  throughput at concurrency 1024 and 4–5% at concurrency 128–256;
  concurrency ≤ 64 and the TEP16/TEP8 latency recipes are at parity
  (within ±2%). Developers investigating can A/B against `ec52c6418b`,
  which is the last commit before this merge. Tracked as TRTLLM-14904.
