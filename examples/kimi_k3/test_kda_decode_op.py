...
assert opt.decode_kernel_path == "optimized", opt.decode_kernel_path
ref = KimiKDALinearAttention(**common, use_optimized_decode=False).to(dev)
ref.load_state_dict(opt.state_dict())
assert ref.decode_kernel_path == "fla", ref.decode_kernel_path
assert ref.prefill_kernel_path == opt.prefill_kernel_path
