...
def load_t5_from_pytorch(tllm_model,
    ...
    pytorch_ckpt = torch.load(pytorch_ckpt_path + f'/{CHECKPOINT_NAME}.ckpt')
    pytorch_model = {
    ...
    if component == "encoder":
        ...
        for i in range(tllm_model.num_layers):
            ...
            layer.gated_mlp.fc.weight.value = pytorch_model[
                f'{layer_prefix}layer.1.DenseReluDense.wi_0.weight']
            layer.gated_mlp.gate.weight.value = pytorch_model[
                f'{layer_prefix}layer.1.DenseReluDense.wi_1.weight']
            layer.gated_mlp.proj.weight.value = pytorch_model[
            ...
            if tllm_model.has_mlp_bias:
                ...
                layer.gated_mlp.gate.weight.value = pytorch_model[
                    f'{layer_prefix}layer.1.DenseReluDense.wi_1.weight']
                layer.gated_mlp.proj.bias.value = pytorch_model[
