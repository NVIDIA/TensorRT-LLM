...
def parse_arguments():
    ...
    parser.add_argument('--output_dir',
                        type=str,
                        default='./internlm2-chat-7b/trt_engines/fp16/1-gpu/',
...
def convert_from_hf(hf_model,
    ...
    num_kv_heads = hf_config.llm_config.num_key_value_heads
    num_hidden_layers = hf_config.llm_config.num_hidden_layers
    ...
    embed_w = convert.get_weight(model_params, 'language_model.model.tok_embeddings', dtype)
    ...
    lm_head_weights = convert.get_weight(model_params, 'language_model.output', dtype)
    if mapping.is_last_pp_rank():
        ...
        weights['lm_head.weight'] = convert.split_matrix_tp(lm_head_weights,
                                                            ...
                                                            mapping.tp_rank,
                                                            dim=0)
        ln_f_w = convert.get_weight(model_params, 'language_model.model.norm', dtype)
...
if __name__ == '__main__':
    ...
    config = {
        ...
        'hidden_size': hf_config.llm_config.hidden_size,
        'intermediate_size': hf_config.llm_config.intermediate_size,
        'norm_epsilon': hf_config.llm_config.rms_norm_eps,
        'vocab_size': hf_config.llm_config.vocab_size,
        'position_embedding_type': 'rope_gpt_neox',
        'rotary_base': hf_config.llm_config.rope_theta,
        'max_position_embeddings': hf_config.llm_config.max_position_embeddings,
        'hidden_act': hf_config.llm_config.hidden_act,
