...
class PyObjectWrapper(ctypes.Structure):
    _fields_ = [
...
def hostfunc(userData):
    # Get the wrapper and extract the Python object
    wrapper = PyObjectWrapper.from_address(userData)
    obj = wrapper.obj
    # obj.inc_logits_bitmask_host()
    obj.echo()
    return 0
