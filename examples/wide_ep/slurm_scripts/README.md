...
Note that, core implementation of the slurm scripts are included in `examples/disaggregated/benchmark/slurm`.
...
```bash
# Refer to `examples/disaggregated/benchmark/slurm/`
# Please find the `disaggr_torch.slurm` script in the `examples/disaggregated/benchmark/slurm/` directory.
