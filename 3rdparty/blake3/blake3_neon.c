...
INLINE uint32x4_t rot8_128(uint32x4_t x)
{
    ...
    return vreinterpretq_u32_u8(__builtin_shufflevector(
        vreinterpretq_u8_u32(x), vreinterpretq_u8_u32(x), 1, 2, 3, 0, 5, 6, 7, 4, 9, 10, 11, 8, 13, 14, 15, 12));
...
INLINE void transpose_msg_vecs4(uint8_t const* const* inputs, size_t block_offset, uint32x4_t out[16])
{
...
static void blake3_hash4_neon(uint8_t const* const* inputs, size_t blocks, const uint32_t key[8], uint64_t counter,
...
INLINE void hash_one_neon(uint8_t const* input, size_t blocks, const uint32_t key[8], uint64_t counter, uint8_t flags,
