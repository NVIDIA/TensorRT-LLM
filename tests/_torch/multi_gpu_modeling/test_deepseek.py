...
def test_deepseek(model_name, quant, tp_size, ep_size, mtp_nextn, enable_dp,
                  enable_cuda_graph, enable_overlap_scheduler):
    model_path = {
        "bf16": "bf16",
        "fp8": "fp8",
        "fp4": "nvfp4_moe_only",
    ...
    if tp_size > 1 and enable_cuda_graph:
        pytest.skip("Hang issue in tensor parallel mode with cuda graph")
...
def test_deepseek_streaming(model_name, quant, tp_size):
    model_path = {
        "bf16": "bf16",
        "fp8": "fp8",
        "fp4": "nvfp4_moe_only",
...
#model_name, quant, tp_size, ep_size, enable_dp,enable_cuda_graph, enable_overlap_scheduler
if __name__ == "__main__":
    test_deepseek("DeepSeek-V3-Lite", "fp8", 1, 1, 0, False, False, False)
