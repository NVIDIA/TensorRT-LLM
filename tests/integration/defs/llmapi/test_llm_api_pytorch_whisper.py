...
# These cases exercise greedy feature combinations; beam coverage lives in
# _BEAM_SEARCH_CASES. The encoder-graphs case additionally captures the encoder
# step, which must not change a single token.
