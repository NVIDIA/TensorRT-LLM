...
Covers unquantized bf16 (Qwen3-MoE) and per-tensor FP8 qdq (Mixtral-8x7B) base
weights, with several adapters of varying rank applied in one batch. The
...
def _write_routed_expert_lora_adapter(
    ...
    *,
    ...
    """Fabricate a per-expert Qwen3-MoE LoRA adapter on disk."""
