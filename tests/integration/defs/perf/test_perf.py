...
class ServerConfig:
    ...
    def __init__(self, server_config_data: dict):
        ...
        if cuda_graph_config:
            ...
            self.cuda_graph_max_batch_size = self.max_batch_size
...
def parse_multi_node_disagg_config_file(config_file_path: str,
    ...
    for disagg_config_data in config.get('disagg_configs', []):
        ...
        disagg_config = {
            ...
            'model_name': model_name,
            'hardware': hardware,
            'ctx_server': ServerConfig(ctx_server_config_data),
            'gen_server': ServerConfig(gen_server_config_data),
    ...
    def upload_test_results_to_database(self):
        ...
        if self._config.runtime == "aggr_server":
            ...
            for disagg_config in self._config.disagg_configs:
                ...
                # Build new_data
                new_data = {"s_runtime": "multi_node_disagg_server"}
                new_data.update(job_config)
