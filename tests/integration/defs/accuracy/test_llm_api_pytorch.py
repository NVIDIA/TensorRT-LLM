...
class TestLlama3_1_8B(LlmapiAccuracyTestHarness):
    ...
    def test_nvfp4_streaming(self, stream_interval, mocker):
        # When stream_interval < 32, hf incremental detokenization is faster.
        # When stream_interval >= 32, trtllm implemented incremental detokenization is faster.
        # The behavior is due to perf considerations, while both paths need to be tested.
        if stream_interval >= 32:
