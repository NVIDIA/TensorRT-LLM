...
def test_ltx2_example(_visual_gen_deps, llm_root, llm_venv):
    """Run examples/visual_gen/models/ltx2.py end-to-end on defaults.

    Validates that the LTX-2 example script runs as documented. The Gemma3 text
    encoder is passed via ``--text_encoder_path``.
    """
