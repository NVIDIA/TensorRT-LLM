...
def test_deepseek_v32_context_forward():
    ...
    with torch.random.fork_rng(devices=[torch.cuda.current_device()]):
        ...
        assert MODEL_CLASS_MAPPING[
            "DeepseekV32ForCausalLM"] is DeepseekV3ForCausalLM
        ...
        def fresh_metadata(length):
            ...
            try:
                ...
                cache_params = KVCacheParams(use_cache=True,
        ...
        assert not torch.allclose(
            logits, bypass_logits.float(), rtol=2e-2, atol=2e-3)
