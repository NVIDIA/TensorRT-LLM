...
class TestStreamingParseFallback:
    """Verify streaming parse failures preserve visible output text."""

    def test_plain_fallback_text_preserves_spacing(self) -> None:
        adapter = HarmonyAdapter(harmony_input=False, harmony_output=False)
    ...
    def test_streaming_response_emits_fallback_content(self) -> None:
        adapter = HarmonyAdapter(harmony_input=False, harmony_output=False)
