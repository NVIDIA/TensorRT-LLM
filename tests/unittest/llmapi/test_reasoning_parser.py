...
def test_telechat_reasoning_parser_registered():
    assert "telechat" in ReasoningParserFactory.keys()
    assert "telechat4" in ReasoningParserFactory.keys()
    assert MODEL_TYPE_TO_REASONING_PARSER["telechat4"] == "telechat"
...
def test_telechat_reasoning_parser_extracts_when_thinking(
        chat_template_kwargs: dict):
    """TeleChat defaults to thinking on, unlike DeepSeek-V4."""
    reasoning_parser = ReasoningParserFactory.create_reasoning_parser(
        "telechat", chat_template_kwargs)
...
def test_telechat_reasoning_parser_strips_leading_start_tag():
    reasoning_parser = ReasoningParserFactory.create_reasoning_parser(
        "telechat4")
...
def test_telechat_reasoning_parser_identity_when_not_thinking():
    reasoning_parser = ReasoningParserFactory.create_reasoning_parser(
        "telechat", {"thinking": False})
...
def test_telechat_reasoning_parser_streams_when_thinking():
    reasoning_parser = ReasoningParserFactory.create_reasoning_parser(
        "telechat")
