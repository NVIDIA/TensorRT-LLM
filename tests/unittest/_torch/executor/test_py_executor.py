...
class TestPendingTransferResponseFlush:
    ...
    def test_overlap_forward_error_preserves_previous_batch_processing(self, monkeypatch):
        executor = self._make_executor_loop_stub()
        executor._can_pause_for_rebalance = Mock(return_value=False)
        ...
        executor._forward_step.assert_called_once_with(scheduled_batch, None, None)
