...
class TestDisaggTransferIdleProgress:
    ...
    def test_falls_back_to_context_transfer_when_idle(self):
        executor = object.__new__(PyExecutor)
    ...
    def test_gen_only_no_context_benchmark_polls_context_when_idle(
        ...
        # The generation-side status vote went away with the admission
        # controller; only the context entry collective remains.
...
def test_nonzero_pp_rank_prepares_snapshot_points_before_local_schedule(
    ...
    executor._pp_schedule_and_propagate = Mock(return_value=(scheduled_batch, [], 0))
