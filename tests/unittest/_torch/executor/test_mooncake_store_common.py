...
"""Unit tests for the Mooncake store pieces that do not need a KV cache layout.
...
through where GPUDirect RDMA is unavailable. The connector that drives them
against real pages is tested in `test_mooncake_store_connector.py`.
