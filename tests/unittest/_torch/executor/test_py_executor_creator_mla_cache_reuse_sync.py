...
from tensorrt_llm._torch.pyexecutor.resource_manager import ResourceManagerType, KVCacheManager, KVCacheManagerV2
...
class _DummyKvCacheCreator:
    ...
    def __init__(self, **kwargs):
        ...
        self.kv_cache_manager_cls = lambda: KVCacheManagerV2 if "use_kv_cache_manager_v2" in kwargs and kwargs["use_kv_cache_manager_v2"] else KVCacheManager
