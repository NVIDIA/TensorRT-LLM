...
class TestSplitKvCacheBudgetForCross:
    ...
    def test_is_encoder_decoder_helper_handles_missing_attr(self):
        pretrained = _make_mock_model_config().pretrained_config
        ...
        creator = _make_creator(_make_mock_kv_cache_config(), model_config=model_config)

        assert not creator._is_encoder_decoder()
