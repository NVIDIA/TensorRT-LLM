...
from tensorrt_llm._torch.pyexecutor.request_utils import (
    balance_requests_across_ranks, can_process_attention_dp_request,
    get_from_waiting_queue, merge_helix_requests, merge_requests,
...
def test_merge_requests_with_helix_cp_config():
    ...
    for rank in [0, 1, 2, 3]:
        ...
        result = merge_requests([request_item],
                                cp_config=cp_config,
                                cp_rank=rank,
                                cp_size=4,
                                exclude_last_generation_logits=False)
