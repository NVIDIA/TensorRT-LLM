...
def test_starcoder2_multi_lora() -> None:
    """
    Test StarCoder2 with multiple synthetic LoRA adapters created using PEFT.
    ...
    3. The model produces outputs with LoRA adapters applied
    """
    import os
    ...
    with tempfile.TemporaryDirectory() as lora_dir:
        ...
        try:
            ...
            outputs_no_lora = llm.generate(
                prompts[:1],  # Just test one prompt
                sampling_params,
                lora_request=None
            )
            ...
            print("\n✓ StarCoder2 multi-LoRA test passed!")
