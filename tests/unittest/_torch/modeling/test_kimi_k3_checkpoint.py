...
from tensorrt_llm._utils import is_sm_100f  # noqa: E402
...
def test_checkpoint_loads_fp8_mla_values(
    ...
    if fp8:
        ...
        expect_dequant = is_sm_100f() and not cute_bmm
        assert (attention.k_b_proj_trans_dequant is not None) == expect_dequant
        assert (attention.v_b_proj_dequant is not None) == expect_dequant
        if expect_dequant:
