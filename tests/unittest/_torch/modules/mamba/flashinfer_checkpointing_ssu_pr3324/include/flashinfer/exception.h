...
public:
    Error(std::string const& func, std::string const& file, int line, std::string const& message)
    {
        std::ostringstream oss;
...
public:
    Warning(std::string const& func, std::string const& file, int line, std::string const& message)
    {
        std::ostringstream oss;
