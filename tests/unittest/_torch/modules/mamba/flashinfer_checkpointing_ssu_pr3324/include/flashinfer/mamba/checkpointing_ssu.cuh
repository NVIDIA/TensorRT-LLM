...
struct CheckpointingSsuParams
{
    ...
    void* __restrict__ old_B{nullptr};             // (state_cache_size, 2, MAX_WINDOW, ngroups, dstate) double-buffered
    void* __restrict__ old_dt{nullptr};            // (state_cache_size, 2, nheads, MAX_WINDOW) double-buffered, f32
    void* __restrict__ old_cumAdt{nullptr};        // (state_cache_size, 2, nheads, MAX_WINDOW) double-buffered, f32
    ...
    int64_t const* rand_seed{nullptr};
