...
from tensorrt_llm._torch.modules.fused_moe.communication import nvlink_one_sided as one_sided_module
from tensorrt_llm._torch.modules.fused_moe.communication import nvlink_two_sided as two_sided_module
