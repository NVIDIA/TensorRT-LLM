...
Shapes match actual Wan inference:
  - T2V 1.3B : latent (1, 16, 1, 60, 104), text (1, 77, 4096)
  - I2V 14B 480P: latent (1, 32, 1, 60, 104), text (1, 512, 4096),
                  image_embeds (1, 257, 1280)
    text_seq_len=512 is required because the I2V cross-attention processor
    uses a hardcoded 512-token boundary to split image vs text context.
