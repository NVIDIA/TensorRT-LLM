...
Run all:
    pytest tests/unittest/_torch/visual_gen/test_wan_i2v_teacache.py -v -s

Run one model:
    pytest tests/unittest/_torch/visual_gen/test_wan_i2v_teacache.py -v -s -k wan21_i2v_480p
    pytest tests/unittest/_torch/visual_gen/test_wan_i2v_teacache.py -v -s -k wan21_i2v_720p
    pytest tests/unittest/_torch/visual_gen/test_wan_i2v_teacache.py -v -s -k wan22_raises
...
# Wan 2.1 I2V checkpoints are not in the standard llm-models root.
# Set the corresponding environment variable to run these tests:
#   DIFFUSION_MODEL_PATH_WAN21_I2V_480P=/path/to/Wan2.1-I2V-14B-480P-Diffusers
#   DIFFUSION_MODEL_PATH_WAN21_I2V_720P=/path/to/Wan2.1-I2V-14B-720P-Diffusers
