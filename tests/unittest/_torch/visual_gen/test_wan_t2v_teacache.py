...
Run all:
    pytest tests/unittest/_torch/visual_gen/test_wan_t2v_teacache.py -v -s

Run one model:
    pytest tests/unittest/_torch/visual_gen/test_wan_t2v_teacache.py -v -s -k wan21_1_3b
    pytest tests/unittest/_torch/visual_gen/test_wan_t2v_teacache.py -v -s -k wan21_14b
    pytest tests/unittest/_torch/visual_gen/test_wan_t2v_teacache.py -v -s -k wan22_raises
...
from tensorrt_llm._torch.visual_gen.config import DiffusionArgs, TeaCacheConfig
