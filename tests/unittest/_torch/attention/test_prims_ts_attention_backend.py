...
def test_prims_ts_oversized_decode_workspace_replays_a_b_a(
    ...
    def select_replay_state(metadata, static_inputs) -> None:
        ...
        wrapper = adapter._decode_wrapper
    ...
    for adapter, root_ptr, root_bytes, thop_ptr, thop_bytes, decode_workspace in workspace_records:
        ...
        assert adapter._decode_wrapper is not None
        assert adapter._decode_wrapper._workspace_buffer.data_ptr() == decode_workspace.data_ptr()
    ...
    captured_wrapper = captured_adapter._decode_wrapper
