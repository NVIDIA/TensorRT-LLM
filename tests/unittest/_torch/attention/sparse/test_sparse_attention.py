...
import tensorrt_llm
from tensorrt_llm._torch.attention_backend.interface import AttentionForwardContext
...
class TestSparseAttention(TrtllmAttention):
    ...
    def sparse_kv_predict(self, q, k, metadata, ctx: AttentionForwardContext):
        return self._sparse_kv_indices, self._sparse_kv_offsets

    def sparse_attn_predict(self, q, k, metadata, ctx: AttentionForwardContext):
