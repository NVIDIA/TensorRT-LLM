...
HND view contract passed to the packaged MSA kernel; the CUDA-gated fused
cache-scatter test checks the single-launch K/V/index-K write against the
legacy per-cache path. Numerical parity against the Triton reference is
covered by the SM100 integration accuracy test.
"""
