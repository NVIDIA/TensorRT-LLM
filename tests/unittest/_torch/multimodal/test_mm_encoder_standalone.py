...
def _assert_handles_are_different(x: dict, y: dict):
...
def test_single_image_chat(
    ...
    with encoder:
        ...
        if pd_disagg:
            ...
            _assert_handles_are_different(
                ep_disaggregated_params.mrope_position_ids_handle,
                pd_disaggregated_params.mrope_position_ids_handle,
            )
