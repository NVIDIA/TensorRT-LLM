...
def test_bounded_mapper_readiness_failure_is_rank_coherent_before_start():
...
def _run_real_mpi_scenarios(checkpoint_dir: str) -> dict:
    ...
    with bounded_success_loader.open_weight_session(
        ...
        bounded_success_loader.activate_weight_session()
    ...
    try:
        with reader_start_loader.open_weight_session(
            ...
            reader_start_loader.activate_weight_session()
