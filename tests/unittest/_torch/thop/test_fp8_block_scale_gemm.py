...
def test_cute_dsl_fp8_block_scale_gemm(dtype, m, k, n):
    ...
    our_out = torch.ops.trtllm.cute_dsl_fp8_gemm(act_a_fp8, act_b_fp8, act_a_sf, act_b_sf)
...
def run_ds_bs_gemm_ref(a, b, a_scale, b_scale, tile_size=128):
    ...
    out = fp8_block_scaling_gemm_reference(a, b, input_scale_tmp, b_scale).cuda().to(torch.bfloat16)
