...
from tensorrt_llm.quantization.mode import W4A16QuantMode
...
class TestW4A16Gemm(unittest.TestCase):
    ...
    def _run_w4a16_gemm(self,
        ...
        quant_mode = W4A16QuantMode.FINEGRAINED_SCALE_ONLY if not has_zero else W4A16QuantMode.FINEGRAINED_SCALE_AND_ZEROS
