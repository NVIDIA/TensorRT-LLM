...
def test_nvfp4_trtllm_gen_non_gated_empty_w3_lists():
    ...
    gm = InferenceOptimizer(
        None,
        {"fuse_nvfp4_trtllm_gen_moe": {"stage": "post_load_fusion"}},
    )(None, gm)
...
def test_nvfp4_moe_ad_trtllm_gen_vs_cutlass_vs_reference(hidden_size, intermediate_size):
    ...
    - AD TRTLLM-Gen: trtllm_nvfp4_trtllm_gen_moe_fused (fuse_nvfp4_trtllm_gen_moe, SM100+ only)
    ...
    # AD TRTLLM-Gen path: fuse_nvfp4_trtllm_gen_moe -> trtllm_nvfp4_trtllm_gen_moe_fused (SM100+)
