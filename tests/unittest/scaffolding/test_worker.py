...
def test_trtllm_worker_copies_finish_reason_from_result():
...
def test_trtllm_worker_returns_length_for_max_num_tokens_error():
    error = RequestError(
...
def test_trtllm_worker_preserves_unrelated_request_errors():
