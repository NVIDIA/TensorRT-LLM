...
class TestReuseScopeCompatibility(unittest.TestCase):
    ...
    def test_blockchain_keys_accept_reuse_scope(self) -> None:
    ...
    def test_radix_tree_match_accepts_reuse_scope(self) -> None:
