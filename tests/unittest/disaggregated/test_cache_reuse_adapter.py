...
# ---------------------------------------------------------------------------
# KvCacheTransceiverV2._trim_kv_to_prompt_history: capability-gated, swallows
# trim_to_history's bool result (graceful-degrade on trim failure).  (#14137/
# #14258 disagg-gen SWA history pre-declaration.)
# ---------------------------------------------------------------------------
...
# ---------------------------------------------------------------------------
# KvCacheTransceiverV2 context-manager (__enter__/__exit__) + shutdown
# idempotency.  (#14137 NIXL agent transfer/shutdown race.)
# ---------------------------------------------------------------------------
