...
@pytest.mark.parametrize(
    ("bounce_size_mb", "agent_enable", "expected_python_bounce", "expected_agent_size_mb"),
    [
        # Shared capacity, Python implementation (default): per-region bounce on, agent off.
        (384, False, ("bounce", 384), 0),
        # Shared capacity, C++ agent implementation: agent arena gets the size, Python off.
        (384, True, None, 384),
...
def test_transceiver_routes_bounce_capacity_to_one_implementation(
    ...
    assert worker_config.agent_buffer_size_mb == expected_agent_size_mb
