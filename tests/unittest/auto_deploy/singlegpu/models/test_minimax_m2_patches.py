...
def test_minimax_m2_moe_patch(model_name):
    """Test that the patched MiniMaxM2SparseMoeBlock forward produces the same output as the original.

    The original HuggingFace implementation is the reference.
